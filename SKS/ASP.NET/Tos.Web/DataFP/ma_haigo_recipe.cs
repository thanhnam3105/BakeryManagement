...
namespace Tos.Web.DataFP
{
    ...
    public partial class ma_haigo_recipe
    {
        ...
        public Nullable<bool> flg_kowake_nochk { get; set; }
        public string cd_shokuba { get; set; }
        public Nullable<double> keisu { get; set; }
        public Nullable<bool> flg_hijyu { get; set; }
        public string cd_station { get; set; }
        public Nullable<int> su_leadtime_kura { get; set; }
    }
}
