<%@ Page Title="権限エラー" Language="C#" AutoEventWireup="true" CodeBehind="AuthorizedError.aspx.cs" Inherits="Tos.Web.AuthorizedError" %>
<%--/** 最終更新日 : 2018-01-25 **/--%>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <% #else %>
    <script src="<%=ResolveUrl("~/Scripts/jquery-ui-1.10.3.min.js") %>" type="text/javascript"></script>
    ...
    <div class="wrap">
        ...
        <div class="navbar navbar-default navbar-fixed-top">
            <div class="navbar-header">
                ...
                <div class="logo"></div>
                <div class="navbar-brand app-title">権限エラー</div>
