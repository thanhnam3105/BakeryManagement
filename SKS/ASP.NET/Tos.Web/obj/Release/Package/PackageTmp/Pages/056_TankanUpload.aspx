<%@ Page Title="056_単価アップロード（アヲハタ）" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="056_TankanUpload.aspx.cs" Inherits="Tos.Web.Pages._056_TankanUpload" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
         ...
         */
        var page = App.define("056_TankanUpload", {
            //TODO: ページのレイアウト構造に対応するオブジェクト定義を記述します。
            options: {},
            values: {
                errorStatusLayoutUpload065: 412
            },
            urls: {},
            header: {
                options: {},
                values: {},
                urls: {
                    tanka_upload_csv: "../api/_056_TankanUpload"
                }
            },
            detail: {
                options: {},
        ...
        */
        ...
        page.header.upload = function (e, args) {
            ...
            $.ajax(App.ajax.file.upload(page.header.urls.tanka_upload_csv, file))
                .then(function (response, status, xhr) {

                    App.ui.page.notifyInfo.message(App.messages.base.uploadsuccess).show();
                    //App.ui.page.notifyInfo.message(App.messages.app.AP0195).show();
                }).fail(function (error) {
                    if (error.responseType === "blob") {
                        ...
                        App.ui.page.notifyAlert.message(App.messages.app.AP0196).show();
                    } else {
                        switch(error.status) {
                            case App.settings.base.validationErrorStatus:
                                App.ui.page.notifyAlert.message(App.messages.app.AP0194).show();
                                break;
                            case page.values.errorStatusLayoutUpload065:
                                App.ui.page.notifyAlert.message(App.messages.app.AP0193).show();
                                break;
                            default:
