<%@ Page Title="005_分析値入力" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="005_BunsekichiNyuryoku.aspx.cs" Inherits="Tos.Web.Pages._005_BunsekichiNyuryoku" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
         ...
         */
        var page = App.define("_005_BunsekichiNyuryoku", {
            ...
            values: {
                isChangeRunning: {},
                //Request #17139 :TOsVN - 19075 - 2020/04/17 [update]:2020/04/22
                hasChange: false,
                firstChange: true,
                //廃止権限
                id_kino_edit: 10,
            ...
            urls: {
                ...
                loadData: "../api/BunsekichiNyuryoku/Get",
                bunekichiNyuryoku: "../api/BunsekichiNyuryoku"
            },
            header: {
                options: {},
                values: {},
            ...
            detailInput: {
                ...
                urls: {
                    dropdown: "../api/BunsekichiNyuryoku/Get_kaisha",
                    chkGenryo: "../Services/ShisaQuickService.svc/ma_genryo?$filter=cd_kaisha eq {0}"
                }
            },
            dialogs: {},
            commands: {}
                ...
                page.validateAll().then(function () {
                    ...
                    .then(function () {
                        ...
                        changeSets = {
                            ...
                            id_kakunin: id_kakunin,
                            updateNmGenryo: updateNmGenryo,
                            chageFlg: page.values.hasChange //Request #17139 :TOsVN - 19075 - 2020/04/17
                        }
                        ...
                        return $.ajax(App.ajax.webapi.put(page.urls.bunekichiNyuryoku, changeSets))
                            .then(function (result) {
                                ...
                                page.detailInput.bind(result);
                                chageFlg = false;
                                page.values.hasChange = false; //Request #17139 :TOsVN - 19075 - 2020/04/17
                                App.ui.page.notifyInfo.message(App.messages.base.MS0002).show();
                                page.detailInput.element.findP("cd_kaisha").val(result.cd_kaisha);
                                App.ui.loading.close();
                            }).fail(function (error) {
                                if (error.status === App.settings.base.conflictStatus || error.status === App.settings.base.validationErrorStatus) {
                                    // TODO: 同時実行エラー時の処理を行っています。
                                    // 既定では、メッセージを表示し、現在の入力情報を切り捨ててサーバーの最新情報を取得しています。
                                    //page.header.search(false);
                                    page.initialize();
        ...
        */
        page.initialize = function () {
            ...
            getKengenGamen(App.settings.app.id_gamen.bunsekiNyuryoku).then(function (results) {
        ...
        page.loadMasterData = function () {
            ...
            return $.ajax(App.ajax.odata.get(page.detailInput.urls.dropdown, { id_user: id_user })).then(function (result) {
        ...
        */
        page.loadData = function () {
            ...
            if (page.values.cd_kaisha && page.values.cd_busho && page.values.cd_genryo) {
                ...
                return $.ajax(App.ajax.webapi.get(page.urls.loadData, {  cd_kaisha: page.values.cd_kaisha
      ...
      */
        ...
        page.detailInput.seigyo = function () {
            ...
            //編集モード時の画面制御
                ...
                //原料コードの最初の１文字がNの場合（画面から作成したデータ）と数字のみの場合（FPから伝送されたデータ）で画面制御を分ける
                var cd_genryo = page.detailInput.element.findP("cd_genryo").val();
                chageFlg = false;
                if (cd_genryo != "") {
                    //原料コードの最初の１文字を取得する
                    var cd_genryo_index = cd_genryo.substring(0, 1);
                    //原料コードの最初の１文字がNの場合（画面から作成したデータ）の画面制御
                    if (cd_genryo_index == "N") {
        ...
        page.detailInput.bind = function (data) {
            ...
            page.values.firstChange = false; //TOsVN - 19075 - 2020/04/22 Request #17139
        };      
        ...
        page.detailInput.change = function (e) {
            ...
            //Start request #17139 :TOsVN - 19075 - 2020/04/17 [update:2020/04/22]
           ...
           <%-- <div title="TODO: ヘッダー部のタイトルを設定します。" class="part">
                ...
                <div class="row">
                    ...
                    <div class="control col-xs-10">
                        <input type="text" data-prop="nm_hinmei" />
                    </div>
                </div>
                -->
            ...
            <div title="分析値入力">
                <div class="row">
                    ...
                    <div class="control col-xs-2">
                        <select data-prop ="cd_kaisha" class ="number"></select>
                        <%--部署コード--%>
                ...
                <div class="row">
                    ...
                    <div class="control col-xs-1">
                        <input type="tel" data-prop ="ritu_sakusan" class ="number-right" maxlength="6" data-number-format="0.00" />
                    </div>
                    <%--食塩(％)--%>
                     <div class="control-label col-xs-1">
                        <label>食塩(％)</label>
                    ...
                    <div class="control col-xs-1">
                        <input type="tel" data-prop ="ritu_shokuen" class ="number-right" maxlength="6" data-number-format="0.00" />
                    </div>
                    <%--総酸(％)--%>
                    <div class="control-label col-xs-1">
                        <label>総酸(％)</label>
                    ...
                    <div class="control col-xs-1">
                        <input type="tel" data-prop ="ritu_sousan" class ="number-right" maxlength="6" data-number-format="0.00" />
                    </div>
                    <%--МＳＧ(％)--%>
                    <div class="control-label col-xs-1">
                        <label>МＳＧ(％)</label>
                    ...
                    <div class="control col-xs-1">
                        <input type="tel" data-prop ="ritu_msg" class ="number-right" maxlength="6" data-number-format="0.00" />
                    </div>
                    <%--油含有量(％)--%>
                    <div class="control-label col-xs-1">
                        <label>油含有量(％)</label>
                    ...
                    <div class="control col-xs-1">
                        <input type="tel" data-prop ="ritu_abura" class ="number-right" maxlength="6" data-number-format="0.00" />
                    </div>
                    <div class="control col-xs-2">
                        <span style="white-space:nowrap;"></span>
                    </div> 
                ...
                <div class="row textarea-height" >
                    ...
                    <div class="control col-xs-11  textarea-height">
                        <textarea data-prop ="memo"  wrap="soft"  class="textareabox" maxlength="200"></textarea>
                    </div>
                </div>
                <div class="row" >
                    <%--入力日--%>
                ...
                <div class="row" >
                    <%--シサクイックラボ更新日--%>
                    <div class="control-label col-xs-1">
                        <label>ｼｻｸｲｯｸﾗﾎﾞ更新日</label>
                    </div>
                    <div class="control col-xs-2">
                        <input type="text" data-prop ="dt_koshin_shisaquicklab"  disabled="disabled" />
                    </div>
                    <%--シサクイックラボ更新者--%>
                    <div class="control-label col-xs-1">
                        <label>ｼｻｸｲｯｸﾗﾎﾞ更新者</label>
                    </div>
                    <div class="control col-xs-2">
                        <input type="text" data-prop ="nm_koshin_shisaquicklab"  disabled="disabled" />
                        <%--シサクイックラボ更新者コード--%>
                        <input type="text" data-prop ="id_koshin_shisaquicklab"  disabled="disabled" hidden />
                    </div>
                    <div class="control col-xs-6">
                        <span style="white-space:nowrap;"></span>
                    </div> 
                ...
                <div class="row" >
                    ...
                    <div class="control col-xs-2">
                        <input type="text" data-prop ="nisugata_hyoji"  disabled="disabled" />
                    </div>
                    <div class="control col-xs-9">
                        <span style="white-space:nowrap;"></span>
                    </div> 
                ...
                <div class="row" >
                    ...
                    <div class="control col-xs-2">
                        <input type="text" data-prop ="rank_ibutsu"  disabled="disabled" />
                    </div>
                    <div class="control col-xs-9">
                        <span style="white-space:nowrap;"></span>
                    </div> 
                ...
                <div class="row" >
                    ...
                    <div class="control col-xs-2">
                        <input type="text" data-prop ="shiyokahi_genryo"  disabled="disabled" />
                    </div>
                    <div class="control col-xs-9">
                        <span style="white-space:nowrap;"></span>
                    </div> 
                ...
                <div class="row textarea-height" >
                    ...
                    <div class="control col-xs-11  textarea-height">
                        <textarea data-prop ="shiyokahi_riyu"  wrap="soft"  class="textareabox" disabled="disabled"></textarea>
                    </div>
                </div>
                <div class="row textarea-cdgenryo" >
                    <%--原料使用可否代替推奨原料コード--%>
                    <div class="control-label col-xs-1 textarea-cdgenryo">
                        <label>原料使用可否</label>
                        <label>代替推奨原料コード</label>
                    </div>
                    <div class="control col-xs-2 textarea-cdgenryo">
                        <input type="text" data-prop ="shiyokahi_cd_genryo_daitai"  disabled="disabled" />
                    </div>
                    <div class="control col-xs-9 textarea-cdgenryo">
                        <span style="white-space:nowrap;"></span>
                    </div>                    
                </div>
                <div class="row textarea-height" >
                    ...
                    <div class="control col-xs-11  textarea-height">
                        <textarea data-prop ="shiyokahi_nm_genryo_daitai"  wrap="soft"  class="textareabox" disabled="disabled"></textarea>
                    </div>
                </div>
                <div class="row" >
                    <%--過去トラブル情報--%>
                    <div class="control-label col-xs-1">
                        <label>過去トラブル情報</label>
                    </div>
                    <div class="control col-xs-2">
                        <input type="text" data-prop ="trouble_joho"  disabled="disabled" />
                    </div>
                    <div class="control col-xs-9">
                        <span style="white-space:nowrap;"></span>
                    </div> 
                ...
                <div class="row textarea-height" >
                    ...
                    <div class="control col-xs-11  textarea-height">
                        <textarea data-prop ="trouble_gaiyo"  wrap="soft" class="textareabox" disabled="disabled"></textarea>
                    </div>
                </div>
                <div class="row textarea-height" >
                    <%--トラブル内容詳細--%>
                    <div class="control-label col-xs-1  textarea-height">
                        <label>トラブル内容詳細</label>
                    </div>
                    <div class="control col-xs-11  textarea-height">
                        <textarea data-prop ="trouble_naiyo_shosai"  wrap="soft" class="textareabox" disabled="disabled"></textarea>
                    </div>
                </div>
                <div class="row" >
                    <%--殺菌調味液要否--%>
                    ...
                    <div class="control col-xs-2">
                        <input type="text" data-prop ="sakkin_chomieki_yohi"  disabled="disabled" />
                    </div>
                    <div class="control col-xs-9">
                        <span style="white-space:nowrap;"></span>
                    </div> 
                ...
                <div class="row textarea-height" >
                    ...
                    <div class="control col-xs-11  textarea-height">
                        <textarea data-prop ="sakkin_chomieki_joken"  wrap="soft"  class="textareabox" disabled="disabled"></textarea>
                    </div>
                </div>
                <div class="row" >
                    <%--ＮＢ限定原料--%>
                    ...
                    <div class="control col-xs-2">
                        <input type="text" data-prop ="NB_genteigenryo"  disabled="disabled" />
                    </div>
                    <div class="control col-xs-9">
                        <span style="white-space:nowrap;"></span>
                    </div> 
                ...
                <div class="row textarea-height" >
                    ...
                    <div class="control col-xs-11  textarea-height">
                        <textarea data-prop ="NB_joken"  wrap="soft"  class="textareabox" disabled="disabled"></textarea>
                    </div>
                </div>
                <div class="row textarea-height" >
                    <%--ＮＢ限定原料設定理由--%>
                    ...
                    <div class="control col-xs-11  textarea-height">
                        <textarea data-prop ="NB_riyu"  wrap="soft"  class="textareabox" disabled="disabled"></textarea>
                    </div>
                </div>
                <div class="row" >
                    <%--酵素活性--%>
                    ...
                    <div class="control col-xs-2">
                        <input type="text" data-prop ="kasseikoso"  disabled="disabled" />
                    </div>
                    <div class="control col-xs-9">
                        <span style="white-space:nowrap;"></span>
                    </div> 
                ...
                <div class="row" >
                    ...
                    <div class="control col-xs-2">
                        <input type="text" data-prop ="gosei_tenkabutu"  disabled="disabled" />
                    </div>
                     <div class="control col-xs-9">
                        <span style="white-space:nowrap;"></span>
                    </div> 
                ...
                <div class="row textarea-height" >
                    ...
                    <div class="control col-xs-11  textarea-height">
                        <textarea data-prop ="biko"  wrap="soft"  class="textareabox" disabled="disabled"></textarea>
                    </div>
                </div>
            </div>
        </div>
