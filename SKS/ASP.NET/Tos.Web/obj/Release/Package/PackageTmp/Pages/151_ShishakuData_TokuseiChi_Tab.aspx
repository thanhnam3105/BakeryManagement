<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="151_ShishakuData_TokuseiChi_Tab.aspx.cs" Inherits="Tos.Web.Pages._151_ShishakuData_TokuseiChi_Tab" %>
...
<script type="text/javascript">
    ...
    */
    ...
    TokuseiChi_Tab.detail.getDisplayNumber = function (value, element) {
        var fixedPosition = element.attr("data-number-format-tofixed");
        var defVal = new BigNumber(0).toFixed(fixedPosition);
        element.val(page.detail.formatNumber(value, fixedPosition, defVal).forDisp);
        return true;
    }
    ...
    TokuseiChi_Tab.detail.options.bindOption = {
        ...
        appliers: {
            ...
            //Brix（％）
            Brix: TokuseiChi_Tab.detail.getDisplayNumber,
            CA: TokuseiChi_Tab.detail.getDisplayNumber,
            ph: TokuseiChi_Tab.detail.getDisplayNumber,
            //Ａｗ
...
<div class="tab-pane" id="TokuseiChi_Tab" style="margin-top: 3px">
    ...
    <table class="datatable" style="display: block;">
        ...
        <tbody class="item-tmpl">
            <tr class="pt-kotei-display data-index-tr-1" data-index-tr="1">
                <td style="width: 15px; text-align: center;" rowspan="1" class="Header enableColor">
                    <input type="checkbox" class="check-head prev_focus" data-prop="flg_Brix" value="1" tabindex="1" />
                </td>
                ...
                <td class="th-tmpl col-sample">
                    <input type="tel" data-prop="Brix" class="limit-input-float-new text-selectAll" maxlength="4" tabindex="2" data-number-format-tofixed="1" />
                </td>
            </tr>

            <tr class=" pt-kotei-display sonohokaeki data-index-tr-2" data-index-tr="2">

                <td style="width: 15px; text-align: center;" rowspan="1" class="Header enableColor">
                    <input type="checkbox" class="check-head prev_focus" data-prop="flg_CA" value="1" tabindex="3" />
                </td>
                <td style="width: 250px" class="border-right-head">
                    <input type="text" value="CA(%)" readonly="readonly" tabindex="-1" />
                </td>
                <td class="th-tmpl col-sample">
                    <input type="tel" data-prop="CA" class="limit-input-float-new text-selectAll" maxlength="5" tabindex="3" data-number-format-tofixed="2" />
                </td>
            </tr>
            <tr class=" pt-kotei-display sonohokaeki data-index-tr-5" data-index-tr="5">
                ...
                <td class="th-tmpl col-sample">
                    <input type="tel" data-prop="ph" class="limit-input-float-new text-selectAll" maxlength="5" tabindex="8" data-number-format-tofixed="2" />
                </td>
            </tr>
