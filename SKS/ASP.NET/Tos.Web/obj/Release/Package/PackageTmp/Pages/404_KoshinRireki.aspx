<%@ Page Title="404_更新履歴" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="404_KoshinRireki.aspx.cs" Inherits="Tos.Web.Pages._404_KoshinRireki" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
         ...
         */
        var page = App.define("_404_KoshinRireki", {
            ...
            urls: {
                ...
                save: "../api/_404_KoshinRireki/Post"
            },
            header: {
                options: {},
                values: {},
                urls: {
                    search: "../api/_404_KoshinRireki"
                }
            },
            detail: {
                options: {},
        ...
        */
        page.initialize = function () {
            ...
            page.values.idFunction = !App.isUndefOrNull(App.uri.queryStrings.id_function) ? App.uri.queryStrings.id_function : null;
        ...
        page.header.createFilter = function () {
            ...
            var filter = {
                id_function: page.values.idFunction,
        ...
        page.detail.options.bindOption = {
            appliers: {
                dt_koshin: function (value, element) {
                    element.text(App.data.getDateTimeString(new Date(value)).substring(0, 16));
                    return true;
                }
            }
        };
            ...
            <table class="datatable">
                ...
                <tbody class="item-tmpl" style="cursor: default; display: none;">
                    <tr>
                        ...
                        <td class="center">
                            <textarea data-prop="nm_koshin"  style="overflow:hidden"></textarea>
                        </td>
                        <td>
                            <label data-prop="nm_tanto" class="overflow-ellipsis"></label>
                        </td>
                    </tr>
                </tbody>
            </table>
