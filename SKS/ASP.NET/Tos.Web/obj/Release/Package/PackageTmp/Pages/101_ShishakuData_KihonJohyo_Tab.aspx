<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="101_ShishakuData_KihonJohyo_Tab.aspx.cs" Inherits="Tos.Web.Pages.ShishakuData_KihonJohyo_Tab" %>
...
<script type="text/javascript">
    ...
    var KihonJohyo_Tab = {
        ...
        urls: {
            loadMasterData: "../api/ShishakuData_KihonJohyo_Tab_/GetMasterData",
        },
        header: {
            options: {},
            values: {},
    ...
    KihonJohyo_Tab.detail.loadMasterData = function () {
        var element = KihonJohyo_Tab.element,
            paraSearch = {
                ...
                K_yoki: App.settings.app.cd_category.yoki_tsutsumi_zai,
                //2019-09-16 : END : Request #15376 基本情報タブ　容器・包材 : カテゴリマスタの容器・包材を出すよう修正をお願い致します。
                K_ikatuhyouzi: App.settings.app.cd_category.ikkatsu_hyoji,
                K_jyanru: App.settings.app.cd_category.janru,
                K_yuza: App.settings.app.cd_category.user,
                K_tokucyogenryo: App.settings.app.cd_category.tokucho_genryo,
                K_yoto: App.settings.app.cd_category.yoto,
                K_kakakutai: App.settings.app.cd_category.kakaku_tai,
                K_syubetu: App.settings.app.cd_category.shubetsu,
                K_shosu: App.settings.app.cd_category.shosu_shitei,
                K_seizohoho: App.settings.app.cd_category.seizo_hoho,
                K_jyutenhoho: App.settings.app.cd_category.juten_hoho,
                K_sakinhoho: App.settings.app.cd_category.sakkin_hoho,
                K_tani: App.settings.app.cd_category.yoryo_tani,
                K_nisugata: App.settings.app.cd_category.nisugata,
                K_toriatukaiondo: App.settings.app.cd_category.toriatsukai_ondo,
        ...
        return $.ajax(App.ajax.webapi.get(KihonJohyo_Tab.urls.loadMasterData, paraSearch)).then(function (result) {
            ...
            //殺菌方法データを保存する。							
            KihonJohyo_Tab.values.dataKsakinhoho = result.K_sakinhoho;
            //容器・包材データを保存する。		
            KihonJohyo_Tab.values.dataKyoki = result.K_yoki;
            //荷姿データを保存する。	
            KihonJohyo_Tab.values.dataKnisugata = result.K_nisugata;

            var K_ikatuhyouzi = element.findP("cd_ikatu"),
                K_jyanru = element.findP("cd_genre"),
                K_yuza = element.findP("cd_user"),
                K_tokucyogenryo = element.findP("tokuchogenryo_data"),
                K_yoto = element.findP("youto_data"),
                K_kakakutai = element.findP("cd_kakaku"),
                K_syubetu = element.findP("cd_shubetu"),
                K_shosu = element.findP("keta_shosu"),
                K_seizohoho = element.findP("cd_hoho"),
                K_jyutenhoho = element.findP("cd_juten"),
                K_sakinhoho = element.findP("hoho_sakin_data"),
                K_yoki = element.findP("youki_data"),
                //K_yokitani = element.findP("yoryo"),
                K_tani = element.findP("cd_tani"),
                K_nisugata = element.findP("cd_nisugata_data"),
                K_toriatukaiondo = element.findP("cd_ondo"),
                K_syomikikan = element.findP("shomikikan_tani"),
                Tanto_kaisha = element.findP("cd_kaisha"),
                HanbaiSeki_kaisha = element.findP("cd_hanseki");
            debugger
            //一括表示	
            K_ikatuhyouzi.children().remove();
            App.ui.appendOptions(
                K_ikatuhyouzi,
                "cd_literal",
                "nm_literal",
                result.K_ikatuhyouzi,
                true
            );

            //ジャンル	
            K_jyanru.children().remove();
            App.ui.appendOptions(
                K_jyanru,
                "cd_literal",
                "nm_literal",
            ...
            //特徴原料		
            K_tokucyogenryo.children().remove();
            App.ui.appendOptions(
                K_tokucyogenryo,
                "nm_literal",
                "nm_literal",
                result.K_tokucyogenryo,
                true
            );

            //用途			
            K_yoto.children().remove();
            App.ui.appendOptions(
                K_yoto,
                "nm_literal",
                "nm_literal",
            ...
            //取扱温度	
            K_toriatukaiondo.children().remove();
            App.ui.appendOptions(
                K_toriatukaiondo,
                "cd_literal",
                "nm_literal",
                result.K_toriatukaiondo,
                true
            );
    ...
    KihonJohyo_Tab.detail.options.validations = {
        ...
        yoryo: {
            rules: {
                ...
                number: true,
                range: [0.1, 9999999.9],
                pointlength: [7, 1]//2020-08-06 :14007 : Bug #18857 内容量0.1でエラーとなる
            ...
            messages: {
                ...
                pointlength: App.messages.base.pointlength//2020-08-06 :14007 : Bug #18857 内容量0.1でエラーとなる
                //num_custom: App.str.format(App.messages.app.AP0140, { param: 1, name: "容量" })
                //2020/06/17 : END : 「容量（数値入力）（※）*」項目に少数1桁まで入力可能変更
            }
        },
        cd_tani: {
        ...
        su_iri: {
            ...
            messages: {
                required: App.messages.base.required,
                num_custom: App.str.format(App.messages.app.AP0140, { param: 1, name: "入り数" })
            }
        },
        shomikikan: {
            rules: {
            ...
            <table class="datatable" style="width: 99.9%">
                ...
                <tbody class="item-tmpl" style="display: none;">
                    <tr>
                        ...
                        <td>
                            <label>所属グループ</label><span class="required">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <label>所属チーム</label><span class="required">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select data-prop="cd_ikatu"></select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select data-prop="cd_genre"></select>
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <label>ユーザ</label><span class="required">*</span>
                        </td>
                        <td>
                            <select data-prop="cd_user"></select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <%--<select data-prop="tokuchogenryo" class="back-yellow select-input"></select>--%>
                            <input type="text" data-prop="tokuchogenryo" class="back-yellow text-selectAll datalistcb" list="tokuchogenryo_data">
                            <datalist id="tokuchogenryo_data" data-prop="tokuchogenryo_data"></datalist>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <%--<select data-prop="youto" class="back-yellow select-input"></select>--%>
                            <input type="text" data-prop="youto" class="back-yellow text-selectAll datalistcb" list="youto_data">
                            <datalist id="youto_data" data-prop="youto_data"></datalist>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select data-prop="cd_kakaku"></select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td rowspan="21" style="background-color: #efefef">
                            <label style="padding: 2px; margin: 2px;">原価試算表</label>
                        </td>
                        <td>
                            <label>販責会社</label><span class="required">*</span>
                        </td>
                        <td>
                            <select data-prop="cd_hanseki" class=""></select>
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <label>工場　担当会社</label><span class="required">*</span>
                        </td>
                        <td>
                            <select data-prop="cd_kaisha" class=""></select>
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <label>工場　担当工場</label><span class="required">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <label>担当営業</label><span class="required">*</span>
                            <button type="button" style="float: right; margin-right: 2px; font-size: 12px; padding: 0px 20px; margin-top: 0px; margin-bottom: 0px;" class="btn btn-primary btn-xs btn-tanto-eigyo">検索</button>
                        </td>
                        <td>
                            <input type="text" data-prop="cd_eigyo" style="display: none" />
                            <label data-prop="nm_eigyo" class="overflow-ellipsis"></label>
                    ...
                    <tr>
                        <td>
                            <label>製造方法</label><span class="required">*</span>
                        </td>
                        <td>
                            <select data-prop="cd_hoho"></select>
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <label>充填方法</label><span class="required">*</span>
                        </td>
                        <td>
                            <select data-prop="cd_juten"></select>
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <label>殺菌方法</label><span class="required">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <label>容器・包材</label><span class="required">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <label>容量（数値入力）（※）</label><span class="required">*</span>
                        </td>
                        <td class="td_tani">
                            <%--2020年度改修案件
                            2020/06/17 : START : 「容量（数値入力）（※）*」項目に少数1桁まで入力可能変更
                    ...
                    <tr>
                        <td>
                            <label>入り数（※）</label><span class="required">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <%--<select data-prop="cd_nisugata" class=" select-input"></select>--%>

                            <input type="text" data-prop="cd_nisugata" class="back-yellow text-selectAll datalistcb" list="cd_nisugata_data">
                            <datalist id="cd_nisugata_data" data-prop="cd_nisugata_data"></datalist>
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <label>取扱温度</label><span class="required">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <label>賞味期間</label><span class="required">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" data-prop="genka" class="text-selectAll" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="tel" data-prop="baika" class="limit-input-float-new text-selectAll" maxlength="15" data-number-format-tofixed="null" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" data-prop="buturyo" class="text-selectAll" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" data-prop="dt_hatubai" class="text-selectAll" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" data-prop="uriage_k" class="text-selectAll" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" data-prop="rieki_k" class="text-selectAll" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" data-prop="uriage_h" class="text-selectAll" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" data-prop="rieki_h" class="text-selectAll" />
                        </td>
                    </tr>
                </tbody>
            </table>
