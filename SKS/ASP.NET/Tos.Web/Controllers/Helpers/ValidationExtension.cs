...
namespace Tos.Web.Controllers.Helpers
{
    ...
    public static class ValidationExtension
    {
        ...
        /// <param name="length">最大値</param>
        /// <returns>検証結果</returns>
        public static ValidationResult Maxmojisu(this string value, int length)
        {
            ValidationResult result = new ValidationResult();
            ...
            {
                result.Errors.Add(string.Format(Properties.Resources.Maxmojisu, length));
            }
        ...
        /// <param name="length">最大値</param>
        /// <returns>検証結果</returns>
        public static ValidationResult MaxByteLengthCustom(this string value, int length)
        {
            ValidationResult result = new ValidationResult();
            ...
            if (Encoding.GetEncoding(Properties.Resources.Encoding).GetByteCount(value) > length)
            {
                result.Errors.Add(string.Format(Properties.Resources.Maxlenght, length));
            }
        ...
        /// <param name="max">最大値</param>
        /// <returns>検証結果</returns>
        public static ValidationResult RangeCustom(this string value, double? min, double? max)
        {
            ValidationResult result = new ValidationResult();
            ...
            if (max < doubleValue || doubleValue < min)
            {
                result.Errors.Add(string.Format(Properties.Resources.TankaOutOfRange, min, max));
            }
        ...
        /// <param name="allowNegativeNumber">負の数の許可</param>
        /// <returns>検証結果</returns>
        public static ValidationResult PointLengthCustom(this string value, int beforePoint, int afterPoint, bool allowNegativeNumber)
        {
            ValidationResult result = new ValidationResult();
            ...
            if (array[0].Length > beforePoint)
            {
                result.Errors.Add(Properties.Resources.TankaMaxlenght);
                return result;
            }
            if (array.Length > 1 && array[1].Length > afterPoint)
            {
