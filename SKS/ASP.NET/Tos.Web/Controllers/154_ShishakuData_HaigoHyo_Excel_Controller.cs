...
{
    public class _154_ShishakuData_HaigoHyo_Excel_Controller : ApiController
    {
        ...
        [HttpGet]
        public HttpResponseMessage Get([FromUri] HaigoHyo_154_ExcelCondition Conditions)
        {
            // 読込テンプレートファイルパス
            ...
            string dirTemlates = templatepath + "\\" + Properties.Resources.ShisakuHyojiYoho154ExcelName + Properties.Resources.ExcelXlsmExtension;
            // 保存Excelファイル名 (製法文書_[製法番号]_[yyyyMMddhhmmss].xlsx)
            string excelname = Properties.Resources.ShisakuHyojiYoho154ExcelName + "_{0}-{1}-{2}_{3}_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + Properties.Resources.ExcelXlsmExtension;
            ...
            HaigoHyo_154_Excel HaigoHyo_154_Excel = EditExcelFile(dirTemlates, Conditions);
            ...
            return FileUploadDownloadUtility.CreateFileResponse(HaigoHyo_154_Excel.getStream(), excelname);
        }
        ...
        private HaigoHyo_154_Excel EditExcelFile(string dirTemlates, HaigoHyo_154_ExcelCondition Conditions)
        {
            HaigoHyo_154_Excel HaigoHyo_154_Excel = new HaigoHyo_154_Excel();
            HaigoHyo_154_Excel.getExcel(dirTemlates, Conditions);
            return HaigoHyo_154_Excel;
        }
        #endregion
    ...
    public class HaigoHyoCell_154
    {
        ...
        public void setValue(object data, ExcelFile Excel, string sheetName, int distanceCol = 0, int distanceRow = 0, bool isAutoGetValue = true)
        {
            ...
            HaigoHyoCell_154 bindPosition = this;
        ...
        private void UpdateValue(ExcelFile Excel, string sheetName, HaigoHyoCell_154 position, string value)
        {
        ...
        public HaigoHyoCell_154 getNextPosition(int distanceCol, int distanceRow)
        {
            HaigoHyoCell_154 result = new HaigoHyoCell_154();
        ...
        // Base contruction
        public HaigoHyoCell_154() { }
        // Adv contruction
        public HaigoHyoCell_154(string property, string position, string type = null, string format = null, object defaultNull = null) 
        {
    ...
    /// </summary>
    public class HaigoHyo_154_Excel
    {
        // Const
        ...
        // Base excel param
        public HaigoHyo_154_ExcelCondition Conditions { get; set; }
        ...
        // Shisaku hin bf data
        private tr_shisakuhin_bf_EXT ShisakuHinData { get; set; }
        // tr_cyuui_bf_bf
        private List<tr_cyuui_bf> cyuuiData { get; set; }
        // Shisaku data
        private List<tr_shisaku_bf> ShisakuData { get; set; }
        // Genryo data
        //private List<tr_genryo> GenryoData { get; set; }
        // Shisaku list data
        private List<sp_shohinkaihatsu_search_154_shisakulist_Result> ShisakuListData { get; set; }
        // Kotei list literal
        private List<sp_shohinkaihatsu_search_154_kotei_Result> KoteiListLiteral { get; set; }
        // List of seq to print
        private List<int> PrintSeqList { get; set; }
        // ShisakuHin mapping list
        private List<HaigoHyoCell_154> ShisakuHinMapping { get; set; }
        // Shisaku mapping list
        private List<HaigoHyoCell_154> ShisakuMapping { get; set; }
        // Shisaku list mapping list
        private List<HaigoHyoCell_154> ShisakuListMapping { get; set; }
        ...
        // Haigo Kyodo Name
        private List<HaigoBFKyodoName> haigoKyodoName { get; set; }
        // Get no_shisaku
        ...
        private void getShisakuHinData()
        {
            ...
            {
                var ShisakuHinData = context.sp_shohinkaihatsu_search_154_shisakuhin(Conditions.cd_shain, Conditions.nen, Conditions.no_oi).FirstOrDefault();
                this.ShisakuHinData = new tr_shisakuhin_bf_EXT();
        ...
        private void getShisakuData()
        {
            using (ShohinKaihatsuEntities context = new ShohinKaihatsuEntities())
            {
                this.ShisakuData = context.tr_shisaku_bf.Where(x => x.cd_shain == Conditions.cd_shain && x.nen == Conditions.nen && x.no_oi == Conditions.no_oi && x.flg_print == FLG_TRUE).OrderBy(x => x.sort_shisaku).ToList();
                // Get print list
        ...
        private void getShisakuListData()
        {
            using (ShohinKaihatsuEntities context = new ShohinKaihatsuEntities())
            {
                this.ShisakuListData = context.sp_shohinkaihatsu_search_154_shisakulist(Conditions.cd_shain, Conditions.nen, Conditions.no_oi).ToList();
            }
        }
        // Get tr_cyuui_bf base on shisaku data
        private tr_cyuui_bf getCyuuiData(tr_shisaku_bf data)
        {
            ...
            using (ShohinKaihatsuEntities context = new ShohinKaihatsuEntities())
            {
                return context.tr_cyuui_bf.Where(x => x.cd_shain == data.cd_shain && x.nen == data.nen && x.no_oi == data.no_oi && x.no_chui == data.no_chui).FirstOrDefault();
            }
        }
        ...
        private void getKoteiListLiteral()
        {
            using (ShohinKaihatsuEntities context = new ShohinKaihatsuEntities())
            {
                HaigoHyoCell_154 baseCell = new HaigoHyoCell_154() { Col = 13, Row = 0 };
                this.KoteiListLiteral = context.sp_shohinkaihatsu_search_154_kotei(Conditions.cd_shain, Conditions.nen, Conditions.no_oi).ToList();

                //
                this.KoteiListLiteral.Add(new sp_shohinkaihatsu_search_154_kotei_Result() { nm_genryo_disp = "合計仕上重量(Kg)", sort_kotei = MAX_SORT_SEQ });
                //this.KoteiListLiteral.Add(new sp_shohinkaihatsu_search_154_kotei_Result() { nm_genryo_disp = "原料費(Kg)", sort_kotei = MAX_SORT_SEQ });
                //this.KoteiListLiteral.Add(new sp_shohinkaihatsu_search_154_kotei_Result() { nm_genryo_disp = "原料費(1個)", sort_kotei = MAX_SORT_SEQ }); 
                this.KoteiListLiteral.Add(new sp_shohinkaihatsu_search_154_kotei_Result() { nm_genryo_disp = "レシピコスト(円/Kg)", sort_kotei = MAX_SORT_SEQ });
                this.KoteiListLiteral.Add(new sp_shohinkaihatsu_search_154_kotei_Result() { nm_genryo_disp = "レシピコスト(円/個)", sort_kotei = MAX_SORT_SEQ });
                this.KoteiListLiteral.Add(new sp_shohinkaihatsu_search_154_kotei_Result() { nm_genryo_disp = "FC", sort_kotei = MAX_SORT_SEQ });
                this.KoteiListLiteral.Add(new sp_shohinkaihatsu_search_154_kotei_Result() { nm_genryo_disp = "Brix(%)", sort_kotei = MAX_SORT_SEQ });
                this.KoteiListLiteral.Add(new sp_shohinkaihatsu_search_154_kotei_Result() { nm_genryo_disp = "pH", sort_kotei = MAX_SORT_SEQ });
                this.KoteiListLiteral.Add(new sp_shohinkaihatsu_search_154_kotei_Result() { nm_genryo_disp = "CA(%)", sort_kotei = MAX_SORT_SEQ });
                if (this.ShisakuData.Count > 0)
                {
                    //shisa_prop_index = INP_QTA_KOTEI_BEG_IND + 4;
                    shisa_prop_index = INP_QTA_KOTEI_BEG_IND + 8;
                    string leftAlign = "Left";
                    var ShisakuFirstData = this.ShisakuData.First();
                    // Brix
                    if (ShisakuFirstData.flg_Brix == 1)
                    {
                        this.insertLiteral("Brix(%)", "Brix", baseCell, HaigoHyoCell_154.NUMBER_TYPE, ONE_POINT);
                    }
                    // pH
                    ...
                    // Brix
                    if (ShisakuFirstData.flg_CA == 1)
                    {
                        this.insertLiteral("CA(%)", "CA", baseCell, HaigoHyoCell_154.NUMBER_TYPE, TWO_POINT);
                    }

                    // フリータイトル1
                    if (ShisakuFirstData.flg_free1 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title1, "free_value1", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル2
                    if (ShisakuFirstData.flg_free2 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title2, "free_value2", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル3
                    if (ShisakuFirstData.flg_free3 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title3, "free_value3", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル4
                    if (ShisakuFirstData.flg_free4 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title4, "free_value4", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル5
                    if (ShisakuFirstData.flg_free5 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title5, "free_value5", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル6
                    if (ShisakuFirstData.flg_free6 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title6, "free_value6", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル7
                    if (ShisakuFirstData.flg_free7 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title7, "free_value7", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル8
                    if (ShisakuFirstData.flg_free8 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title8, "free_value8", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル9
                    if (ShisakuFirstData.flg_free9 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title9, "free_value9", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル10
                    if (ShisakuFirstData.flg_free10 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title10, "free_value10", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル11
                    if (ShisakuFirstData.flg_free11 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title11, "free_value11", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル12
                    if (ShisakuFirstData.flg_free12 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title12, "free_value12", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル13
                    if (ShisakuFirstData.flg_free13 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title13, "free_value13", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル14
                    if (ShisakuFirstData.flg_free14 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title14, "free_value14", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル15
                    if (ShisakuFirstData.flg_free15 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title15, "free_value15", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル16
                    if (ShisakuFirstData.flg_free16 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title16, "free_value16", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル17
                    if (ShisakuFirstData.flg_free17 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title17, "free_value17", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル18
                    if (ShisakuFirstData.flg_free18 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title18, "free_value18", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル19
                    if (ShisakuFirstData.flg_free19 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title19, "free_value19", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                    // フリータイトル20
                    if (ShisakuFirstData.flg_free20 == 1)
                    {
                        this.insertLiteral(ShisakuFirstData.free_title20, "free_value20", baseCell, HaigoHyoCell_154.STRING_TYPE, null, leftAlign);
                    }
                }
            }
        }
        // Insert literal to literal list
        private HaigoHyoCell_154 insertLiteral(string nm_genryo_disp, string property, HaigoHyoCell_154 baseCell, string cellType = null, string format = null, string align = null)
        {
            this.KoteiListLiteral.Add(new sp_shohinkaihatsu_search_154_kotei_Result() { nm_genryo_disp = nm_genryo_disp, sort_kotei = MAX_SORT_SEQ });
        ...
        {
            var LiteralMapping = new List<HaigoHyoCell_154>();
            LiteralMapping.Add(new HaigoHyoCell_154("cd_genryo_disp", "A10"));
            LiteralMapping.Add(new HaigoHyoCell_154("nm_genryo_disp", "B10"));
            LiteralMapping.Add(new HaigoHyoCell_154("tanka", "F10", HaigoHyoCell_154.NUMBER_TYPE, TWO_POINT, 0));
            LiteralMapping.Add(new HaigoHyoCell_154("budomari", "G10", HaigoHyoCell_154.NUMBER_TYPE, TWO_POINT, 0));
        ...
        {
            this.ShisakuMapping.Add(new HaigoHyoCell_154("dt_shisaku", "M6", HaigoHyoCell_154.DATE_TYPE));
            this.ShisakuMapping.Add(new HaigoHyoCell_154("nm_sample", "M7"));
            this.ShisakuMapping.Add(new HaigoHyoCell_154("memo", "M8"));
            this.ShisakuMapping.Add(new HaigoHyoCell_154("juryo_shiagari_g", "M313", HaigoHyoCell_154.NUMBER_TYPE, this.formatNumber));
            this.ShisakuMapping.Add(new HaigoHyoCell_154("kg_costrecipe", "M314", HaigoHyoCell_154.NUMBER_TYPE, TWO_POINT));
            this.ShisakuMapping.Add(new HaigoHyoCell_154("ko_costrecipe", "M315", HaigoHyoCell_154.NUMBER_TYPE, TWO_POINT));
            this.ShisakuMapping.Add(new HaigoHyoCell_154("su_fc", "M316", HaigoHyoCell_154.NUMBER_TYPE, ONE_POINT));
            this.ShisakuMapping.Add(new HaigoHyoCell_154("su_brix", "M317", HaigoHyoCell_154.NUMBER_TYPE, ONE_POINT));
            this.ShisakuMapping.Add(new HaigoHyoCell_154("su_ph", "M318", HaigoHyoCell_154.NUMBER_TYPE, TWO_POINT));
            this.ShisakuMapping.Add(new HaigoHyoCell_154("su_ca", "M319", HaigoHyoCell_154.NUMBER_TYPE, TWO_POINT));

            //List<HaigoHyoCell_154> GenryoMapping = new List<HaigoHyoCell_154>();
            //GenryoMapping.Add(new HaigoHyoCell_154("genryohi", "M314", HaigoHyoCell_154.NUMBER_TYPE, "0.00", 0));
            //GenryoMapping.Add(new HaigoHyoCell_154("genryohi1", "M315", HaigoHyoCell_154.NUMBER_TYPE, "0.00", 0));

            List<HaigoHyoCell_154> CyuuiMapping = new List<HaigoHyoCell_154>();
            CyuuiMapping.Add(new HaigoHyoCell_154("cyuui_nm_sample", "AG7"));
            CyuuiMapping.Add(new HaigoHyoCell_154("cyuui_no_chui", "AG8", HaigoHyoCell_154.STRING_TYPE, null, "工程版: 0"));
            CyuuiMapping.Add(new HaigoHyoCell_154("chuijiko", "AG9"));
            ...
            for (var i = 0; i < this.ShisakuData.Count; i++)
            {
                ...
                if (i < 3)
                {
                    tr_cyuui_bf cyuuiData = getCyuuiData(objData);
        ...
        {
            List<HaigoHyoCell_154> Mapping = new List<HaigoHyoCell_154>();
            //var Cell = new HaigoHyoCell_154("quantity", "M10", HaigoHyoCell_154.NUMBER_TYPE, this.formatNumber);
            var Cell = new HaigoHyoCell_154("quantity_kanzan", "M10", HaigoHyoCell_154.NUMBER_TYPE, this.formatNumber);
            Mapping.Add(Cell);
            for (var i = 0; i < this.ShisakuData.Count; i++)
            {
        ...
        // Get excel file
        public void getExcel(string dirTemlates, HaigoHyo_154_ExcelCondition Conditions)
        {
            if (Conditions == null)
            {
                return;
            ...
            // ShisakuHin Mapping list
            this.ShisakuHinMapping = new List<HaigoHyoCell_154>();
            this.ShisakuHinMapping.Add(new HaigoHyoCell_154("no_shisaku", "B1"));        
            this.ShisakuHinMapping.Add(new HaigoHyoCell_154("no_irai", "F1"));           
            this.ShisakuHinMapping.Add(new HaigoHyoCell_154("nm_hin", "B2"));            
            this.ShisakuHinMapping.Add(new HaigoHyoCell_154("nm_kaisha", "B4"));         
            this.ShisakuHinMapping.Add(new HaigoHyoCell_154("nm_busho", "B5"));          
            this.ShisakuHinMapping.Add(new HaigoHyoCell_154("nm_user", "B6"));
            this.ShisakuHinMapping.Add(new HaigoHyoCell_154("sys_date", "B7"));
            this.ShisakuHinMapping.Add(new HaigoHyoCell_154("yoryo_cd_tani", "B8"));
            this.ShisakuHinMapping.Add(new HaigoHyoCell_154("memo_shisaku", "AM8"));

            // Shisaku Mapping list
            this.ShisakuMapping = new List<HaigoHyoCell_154>();

            // Shisaku list Mapping list
            this.ShisakuListMapping = new List<HaigoHyoCell_154>();
            ...
            //{
            //    var testCell = new HaigoHyoCell_154() { Row = (int)i + 10, Col = 15, type = HaigoHyoCell_154.NUMBER_TYPE };
        ...
        /// </summary>
        private void getHaigoBFKyodoName()
        {
            this.haigoKyodoName = new List<HaigoBFKyodoName>();
    ...
    /// Excel request param
    /// </summary>
    public class HaigoHyo_154_ExcelCondition
    {
    ...
    /// <summary>
    /// extend of tr_shisakuhin_bf
    /// </summary>
    public class tr_shisakuhin_bf_EXT : sp_shohinkaihatsu_search_154_shisakuhin_Result
    {
