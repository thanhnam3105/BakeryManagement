<%@ Page Title="054_試作分析データ確認（アヲハタ）" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="054_ShisakuBunsekiDataKakunin.aspx.cs" Inherits="Tos.Web.Pages._054_ShisakuBunsekiDataKakunin" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
         ...
         */
        var page = App.define("054_ShisakuBunsekiDataKakunin", {
            ...
            values: {
                isChangeRunning: {},
                transferDetail: "055_BunsekichiNyuryoku.aspx?cd_kaisha={0}&cd_busho={1}&cd_genryo={2}",
                transferNew: "055_BunsekichiNyuryoku.aspx",
                transferPages: {}
            },
            urls: {
                mainMenu: "MainMenu.aspx",
                search: "../api/_054_ShisakuBunsekiDataKakunin",
            ...
            header: {
                ...
                urls: {
                    ...
                    kojyo: "../api/_054_ShisakuBunsekiDataKakunin/Get_busho",
                }
            },
            detail: {
                options: {},
                values: {},
                urls: {
                    downcsv: "../api/_054_ShisakuBunsekiDataKakunin/Get_csv"
                }
            },
            dialogs: {},
            commands: {}
                        ...
                        .then(function (result) {
                            ...
                            if (error.status === App.settings.base.validationErrorStatus) {
                                ...
                                if (App.isArray(errors)) {
                                    ...
                                    App.ui.page.notifyAlert.message(
                                        errors.Message +
                                        (App.isUndefOrNull(errors.InvalidationName) ? "" : errors.Data[errors.InvalidationName])
                                    ).show();
                                }
        ...
        */
        page.initialize = function () {
            ...
            getKengenGamen(App.settings.app.id_gamen.bunsekiDataKakunin_AOH).then(function (results) {

                if (results.length < 1) {
                    window.location.href = page.urls.mainMenu;
                }

                if (results.length >= 1 && (results[0].id_gamen != App.settings.app.id_gamen.bunsekiDataKakunin_AOH || results[0].id_kino != App.settings.app.id_kino.id_kino_gate)) {
                    window.location.href = page.urls.mainMenu;
                }
            });
        ...
        page.header.clear = function () {
            ...
            element.findP("checkBGenryo").prop("checked", true);
        ...
        page.loadMasterData = function () {
            ...
            return $.ajax(App.ajax.odata.get(App.str.format(page.header.urls.kaisha, App.settings.app.kaisha_AOH))).then(function (result) {

                var cd_kaisha = $(".header").findP("cd_kaisha"),
                    nm_kaisha = $(".header").findP("nm_kaisha");

                if (result.value.length > 0) {
                    cd_kaisha.text(result.value[0].cd_kaisha);
                    nm_kaisha.val(result.value[0].nm_kaisha)
                }

                var cd_kaisha = Number($.findP("cd_kaisha").text());
                ...
                rules: {
                    checkGenryo: function (value, opts, state, done) {
                        var checkGenryo = $.findP("checkGenryo").is(":checked"),
                            checkBGenryo = $.findP("checkBGenryo").is(":checked");
                        if (checkGenryo == false && checkBGenryo == false) {
                            done(false);
                        } else {
                            done(true);
                        }
        ...
        page.header.kaishaCombox = function () {
            cd_kaisha = page.header.element.findP("cd_kaisha").text();
            return $.ajax(App.ajax.odata.get(page.header.urls.kojyo, { cd_kaisha: cd_kaisha, fg_hyoji: 1 }))
                    .then(function (result) {
        ...
        page.header.search = function (isLoading) {
            ...
            page.header.validator.validate().done(function () {
                ...
                page.options.filter = {
                    ...
                    checkBGenryo: element.findP("checkBGenryo").is(":checked") ? false : true,
                    flg_shiyo: element.find(".flg_shiyo").is(":checked") ? 1 : 0,
                    tani_OAH: App.settings.app.cd_category.genryo_tani_AOH,
...
--%>
        ...
        page.detail.options.validations = {
            //TODO: 画面明細のバリデーションの定義を記述します。
                cd_genryo: {
                    rules: { 
                        checkBGenryo:function (value, opts, state, done) {
                    ...
                    options: {},
                    messages: {
                        checkBGenryo: App.messages.app.AP0103
                    }
                },
                haishi: {
                    rules: {
        ...
        page.loadData = function () {//試作データ画面遷移時
            if (!App.isUndefOrNull(page.values.cd_kaisha)) {//会社コンボボックス
                $(".header").findP("cd_kaisha").text(page.values.cd_kaisha);
                page.header.kaishaCombox();
            }
            ...
            appliers: {
                ...
                wt_kayosei_kokeibutsu: function (value, element) {
                    if (App.isUndefOrNull(value) || value.toString() == "") {
                        ...
                        element.text(App.num.format(Number(value), "0.000"));
                    }
                    return true;
                },
                ...
                wt_hiju: function (value, element) {
                    if (App.isUndefOrNull(value) || value.toString() == "") {
                        ...
                        element.text(App.num.format(Number(value), "0.00"));
                    }
                    return true;
                },
            ...
            <div title="検索条件" class="part">
                <div class="row">
                    <div class="control col-xs-4">
                        ...
                        <input type="checkbox" style="width: 45px;" checked data-prop="checkBGenryo"/ >
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="control col-xs-2">
                        <label style="display:none;" data-prop="cd_kaisha"></label>
                        <input type="text" data-prop="nm_kaisha" disabled/>
                    </div>
                    <div class="control col-xs-2">
                ...
                <table class="datatable">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" style="width: 100px;">果肉量</th>
                            <th rowspan="2" style="width: 100px;">砂糖量</th>
                            <th rowspan="2" style="width: 100px;">可溶性固形物</th>
                            <th rowspan="2" style="width: 100px;">甘味度</th>
                            <th rowspan="2" style="width: 100px;">比重</th>
                            <th rowspan="2" style="width: 100px;">入れ目量</th>
                            <th rowspan="2" style="width: 100px;">1缶重量</th>
                            <th rowspan="2" style="width: 100px;">砂糖甘味料</th>
                            <th rowspan="2" style="width: 100px;">ペクチンガム類</th>
                            <th rowspan="2" style="width: 100px;">単位</th>
                            <th rowspan="2" style="width: 100px;">単価</th>
                            ...
                            <th rowspan="2" style="width: 500px;">アレルギー情報<br>G-Mer（表示要）</th>
                            <th rowspan="2" style="width: 500px;">アレルギー情報<br>G-Mer（表示不要）</th>
                    ...
                    <tbody class="item-tmpl" style="cursor: default; display: none;">
                        <tr>						
                            ...
                            <td rowspan="2" style="word-wrap:break-word;" class="text-right">
                                <span data-prop="wt_kaniku"></span>
                            </td>
                            <td rowspan="2" style="word-wrap:break-word;" class="text-right">
                                <span data-prop="wt_sato"></span>
                            </td>
                            <td rowspan="2" style="word-wrap:break-word;" class="text-right">
                                <span data-prop="wt_kayosei_kokeibutsu"></span>
                            </td>
                            <td rowspan="2" style="word-wrap:break-word;" class="text-right">
                                <span data-prop="wt_kanmido"></span>
                            </td>
                            <td rowspan="2" style="word-wrap:break-word;" class="text-right">
                                <span data-prop="wt_hiju"></span>
                            </td>
                            <td rowspan="2" style="word-wrap:break-word;"class="text-right">
                                <span data-prop="wt_ireme"></span>
                            </td>
                            <td rowspan="2" style="word-wrap:break-word;" class="text-right">
                                <span data-prop="wt_1_kan"></span>
                            </td>
                            <td rowspan="2" style="word-wrap:break-word;" class="text-center">
                                <span data-prop="kbn_sato"></span>
                            </td>
                            <td rowspan="2" style="word-wrap:break-word;" class="text-center">
                                <span data-prop="kbn_gum"></span>
                            </td>
                            <td rowspan="2" style="word-wrap:break-word;">
                                <span data-prop="cd_tani_master" style="display: none;"></span>
                                <span data-prop="tani"></span>
                            </td>
                            <td rowspan="2" style="word-wrap:break-word;" class="text-right">
                                <span data-prop="tanka"></span>
                            </td>
                            <td rowspan="2" style="word-wrap:break-word;">
