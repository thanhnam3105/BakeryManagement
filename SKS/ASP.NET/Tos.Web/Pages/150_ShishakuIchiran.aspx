<%@ Page Title="150_試作データ一覧（アヲハタ）" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="150_ShishakuIchiran.aspx.cs" Inherits="Tos.Web.Pages._150_ShishakuIchiran" %>
    ...
    <script type="text/javascript">
        ...
        var page = App.define("ShishakuIchiran", {
            ...
            urls: {
                ...
                Post_haita: "../api/_151_ShishakuData/Post_haita",
            ...
            header: {
                ...
                urls: {
                    ...
                    tanto: "../Services/ShisaQuickService.svc/ma_user?$filter=cd_group eq {0} and cd_kaisha eq {1} and cd_team eq {2} &$orderby=id_user",
                    ...
                    search: "../api/_150_Shishakuichiran",
                    ...
                    nm_group: "../api/_150_Shishakuichiran/GetGroupByUser?cd_shain={0}&cd_kaisha={1}",
                }
            },
            detail: {
                options: {},
        ...
        */
        ...
        page.commands.copyItem = function () {
            ...
            //window.open("151_ShishakuData.aspx?mode=2")
            //window.open("151_ShishakuData.aspx?mode=2", "_blank");
            winObj = App.ui.transfer("151_ShishakuData.aspx?mode=2", { wins: page.values.transferPages });
        ...
        */
        page.initialize = function () {
            ...
            page.loadMasterData().then(function (result) {
                ...
                getKengenGamen(App.settings.app.id_gamen.shisaku_data_AOH).then(function (results) {
        ...
        */
        ...
        page.loadMasterData = function () {
            page.header.values.cd_kaisha = App.settings.app.kaisha_AOH;

            return $.ajax(App.ajax.webapi.get(App.str.format(page.header.urls.nm_group, App.ui.page.user.EmployeeCD, App.settings.app.kaisha_AOH))).then(function (groupData) {
                if (!groupData) return App.async.success();

                App.ui.page.user.cd_group = groupData.cd_group;

                var group = page.header.element.findP("nm_group");
                group.val(groupData.nm_group);

                return App.async.all({
                    team: $.ajax(App.ajax.odata.get(App.str.format(page.header.urls.team, App.ui.page.user.cd_group, App.ui.page.user.cd_team))),
                    tanto: $.ajax(App.ajax.odata.get(App.str.format(page.header.urls.tanto, App.ui.page.user.cd_group, page.header.values.cd_kaisha, App.ui.page.user.cd_team))),
                    naiyobunrui: $.ajax(App.ajax.odata.get(App.str.format(page.header.urls.literal, App.settings.app.cd_category.naiyobunrui))),
                    //brand: $.ajax(App.ajax.odata.get(App.str.format(page.header.urls.literal, App.settings.app.cd_category.brand)))

                }).then(function (result) {

                    var teamData = result.successes.team;
                    ...
                    var tantoData = result.successes.tanto;
                    ...
                    var naiyobunruiData = result.successes.naiyobunrui;
                    var naiyobunrui = page.header.element.findP("cd_naiyobunrui");
                    naiyobunrui.children().remove();
                    App.ui.appendOptions(
                        naiyobunrui,
                        "cd_literal",
                        "nm_literal",
                        naiyobunruiData.value,
                        true
                    );

                    //var brandData = result.successes.brand;
                    //var brand = page.header.element.findP("cd_brand");
        ...
        */
            ...
            element.validation().validate({
                ...
                if (property == "team") {
                    ...
                    if (element.findP("team").val() != "") {
                        $.ajax(App.ajax.odata.get(App.str.format(page.header.urls.tanto, App.ui.page.user.cd_group, page.header.values.cd_kaisha, element.findP("team").val())))
                       .then(function (result) {
                           App.ui.appendOptions(
                               tanto,
                               "id_user",
        ...
        page.header.createFilter = function () {
            ...
            return filters = {
                ...
                cd_naiyobunrui: criteria.cd_naiyobunrui,
                brand: criteria.brand,
                id_data: page.values.id_data == 9 ? null : page.values.id_data,
        ...
        page.detail.initialize = function () {
            ...
            element.on("click", "#add-item", function () {
                //window.open("151_ShishakuData.aspx?modeDisp=" + App.settings.app.m_shisaku_data.shinki);
                //window.open("151_ShishakuData.aspx?modeDisp=" + App.settings.app.m_shisaku_data.shinki, "_blank");
                var winObj;
                winObj = App.ui.transfer("151_ShishakuData.aspx?modeDisp=" + App.settings.app.m_shisaku_data.shinki, { wins: page.values.transferPages });
                page.values.transferPages[winObj.name] = winObj.win;
            });
        ...
        page.detail.showEditWindow = function (e) {
            ...
            if (!selected.length) {
                App.ui.page.notifyInfo.message(App.messages.app.AP0008, "AP0008_Edit").show();
                return;
            }
            ...
            App.ui.wait(sleep, condition, 100).then(function () {
                ...
                var link = "151_ShishakuData.aspx?modeDisp=" + mode + "&cd_shain=" + cd_shain + "&nen=" + nen + "&no_oi=" + no_oi;
                //window.open(link);
        ...
        */
        ...
        //page.tabSeek = function (target) {
        //    var nextIndex = target.attr("data-tab-direct");
        //    if (nextIndex) {
        //        var nextTarget = target.closest(".header").findP(nextIndex);
        //        if (nextTarget.length && (nextTarget.is(":disabled") || !nextTarget.is(":visible"))) {
        //            return page.tabSeek(nextTarget);
        //        }
        ...
        //        }
        //        //if (e.shiftKey) {
        //        //    nextIndex = target.attr("data-prop");
        //        //    nextIndex = target.closest(".header").find("[data-tab-direct='" + nextIndex + "']").attr("data-prop");
        //        //}
        //        //if (nextIndex) {
        //        //    var nextTarget = target.closest(".header").findP(nextIndex);
    ...
    <div class="content-wrap smaller">
        ...
        <div class="header">
            ...
            <div title="検索条件" class="part">
                <div class="row">
                    <div class="col-xs-5 control">
                        <label class="check-group">
                            製法も検索対象
                            <input type="checkbox" data-prop="check_no_seiho1" tabindex="1"/>
                        </label>
                        <%--<label class="check-group">
                            条件で絞込み
                        ...
                        <label class="check-group">
                            廃止も検索対象
                            <input type="checkbox" data-prop="checkHaishi"  tabindex="1"/>
                        </label>
                        <%--<label class="check-group">
                            原価依頼のみ
                ...
                <div class="row">
                    ...
                    <div class="control col-xs-2">
                        <input type="text" data-prop="cd_shain_nen_no_oi" maxlength="17" data-tab-direct="no_seiho1" tabindex="2" />
                    </div>
                    <div class="control-label col-xs-1">
                        <label>所属グループ</label>
                    </div>
                    <div class="control col-xs-2">
                        ...
                        <input type="text" data-prop="nm_group" disabled="disabled" />
                    </div>
                    <div class="control-label col-xs-1">
                        <label>原料</label>
                    </div>
                    <div class="control col-xs-3">
                        <input type="text" data-prop="cd_nm_genryo" data-tab-direct="cd_naiyobunrui" tabindex="4" />
                    </div>
                    <div class="control col-xs-2">
                ...
                <div class="row">
                    ...
                    <div class="control col-xs-2">
                        <input type="text" data-prop="no_seiho1" maxlength="16" disabled="disabled" data-tab-direct="nm_hin" style="text-transform:uppercase;" tabindex="2" />
                    </div>
                    <div class="control-label col-xs-1">
                        <label>所属チーム</label>
                    </div>
                    <div class="control col-xs-2">
                        <select data-prop="team" data-tab-direct="tanto" tabindex="3"></select>
                    </div>
                    <%--<div class="control-label col-xs-1">
                        <label>一括表示名称</label>
                    </div>
                    ...
                    <div class="control col-xs-2">
                        <select data-prop="cd_naiyobunrui" data-tab-direct="brand" tabindex="4" ></select>
                    </div>
                    <div class="control col-xs-3">
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="control col-xs-2">
                        <input type="text" data-prop="nm_hin" data-tab-direct="team" tabindex="2" />
                    </div>
                    <div class="control-label col-xs-1">
                        <label>担当者</label>
                    </div>
                    <div class="control col-xs-2">
                        <select data-prop="tanto" data-tab-direct="cd_nm_genryo" tabindex="3" ></select>
                    </div>
                    <div class="control-label col-xs-1">
                        <label>ブランド</label>
                    </div>
                    <div class="control col-xs-2">
                        <%--<select data-prop="cd_brand" data-tab-direct="search" tabindex="4"></select>--%>                        
                        <input type="text" data-prop="brand" data-tab-direct="search" tabindex="4" />
                    </div>
                    <%--<div class="control-label col-xs-1">
                        <label>ユーザー</label>
                    </div>
                ...
                <div class="header-command">
                    <button type="button" id="search" data-prop="search" class="btn btn-sm btn-primary" tabindex="5">検索</button>
                </div>
            </div>
        </div>
        ...
        <div class="detail">
            ...
            <div class="control-label toolbar">
                <i class="icon-th"></i>
                <div class="btn-group">
                    <button type="button" class="btn btn-default btn-xs" id="add-item" tabindex="6" disabled>新規</button>
                </div>
            ...
            <table class="datatable ellipsis">
                ...
                <thead>
                    <tr>
                        ...
                        <th style="width: 150px;">ブランド</th>
                        <th style="width: 150px;">内容分類</th>
                ...
                <tbody class="item-tmpl" style="cursor: default; display: none;">
                    <tr>
                        ...
                        <td class="right">
                            ...
                            <label data-prop="no_row"></label>
                        </td>
                        <td class="center">
                            <button type="button" class="btn btn-info btn-xt min-zero edit-select" style="width: 80%" disabled tabindex="7">詳細</button>
                        </td>
                        <td>
                        ...
                        <td>
                            <label data-prop="nm_brand"></label>
                        </td>
                        <td>    
                            <label data-prop="nm_naiyobunrui"></label>
                        </td>
                        <td>
            ...
            <div class="detail-command">
                <button type="button" id="nextsearch" class="btn btn-sm btn-primary btn-next-search" style="display: none" tabindex="7">次を検索</button>
            </div>
...
<asp:Content ID="FooterContent" ContentPlaceHolderID="FooterContent" runat="server">
    <div class="command-left">
        ...
        <button type="button" id="clear" class="btn btn-sm btn-primary" tabindex="8">クリア</button>
    </div>
    <div class="command">
        ...
        <button type="button" id="reset" class="btn btn-sm btn-primary" disabled tabindex="9">排他クリア（試作）</button>
        ...
        <button type="button" id="copy" class="btn btn-sm btn-primary" disabled tabindex="9">製法支援コピー</button>
    </div>
