<%@ Page Title="151_試作データ（アヲハタ）" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="151_ShishakuData.aspx.cs" Inherits="Tos.Web.Pages._151_ShishakuData" %>
    ...
    <script type="text/javascript">
        ...
        var page = App.define("ShishakuData", {
            ...
            urls: {
                ...
                haigohyo_tab: "../Pages/151_ShishakuData_HaigoHyo_Tab.aspx",
                tokuseichi_tab: "../Pages/151_ShishakuData_TokuseiChi_Tab.aspx",
                kihonjohyo_tab: "../Pages/151_ShishakuData_KihonJohyo_Tab.aspx",
                genkashisan_tab: "../Pages/151_ShishakuData_GenkaShisan_Tab.aspx",
            ...
            header: {
                ...
                values: {},
                urls: {
                    shisakuhin: "../api/_151_ShishakuData",
                    loadMasterData: "../api/_151_ShishakuData/GetMasterData",
                    genryoDelivery: "../api/_151_ShishakuData/Post_GenryoDelivery",
                    Post_haita: "../api/_151_ShishakuData/Post_haita"//2019-12-17 : Request #16147 : 使用中（他の人が開いている）の場合、初期表示時に「他の方が開いているため、参照モードで開きます」のメッセージを通知し、参照モードで開く。
                }
            },
            detail: {
                tabs: {
            ...
            dialogs: {
                urls: {
                    ...
                    //_650_SeizoKoteiDialog: "Dialogs/650_SeizoKoteiDialog.aspx",
                    _650_SeizoKoteiDialog: "Dialogs/650_SeizoKoteiDialog.aspx",
            ...
            commands: {
                urls: {
                    save: "../api/_151_ShishakuData",
                    genryoDelivery: "054_ShisakuBunsekiDataKakunin.aspx?id_session={id_session}&cd_kaisha={cd_kaisha}&cd_kojo={cd_kojo}",
                    ...
                    shishakuDataHyojiYokoExcel153: "../api/_153_ShishakuData_HyojiYoko_Excel_/GetExcel",
                    shishakuDataHaigoHyoExcel154: "../api/_154_ShishakuData_HaigoHyo_Excel_",
                    sanpuruSetsumeishoExcel156: "../api/_156_ShishakuData_SanpuruSetsumeisho_Excel_",
                }
            }
        });
            ...
            element.validation().validate({
                ...
                page.detail.tabs.haigohyo_tab.shisakuKopiChecked().then(function (seq_shisaku_checked) {
                    ...
                    $.ajax(App.ajax.odata.get(App.str.format(page.urls.checkSeiho, shubetsuLabel))).then(function (result) {
                        if (!result.value.length) {
                            App.ui.page.notifyAlert.message(App.str.format(App.messages.app.AP0031, { name: "種別" })).show();
                            App.ui.loading.close();
                            return;
                        }
                        //種別 + 種別番号
            ...
            page.dialogs.confirmDialog.confirm(options).then(function () {
                ...
                setTimeout(function () {
                    var changeSets = {
                        ...
                        , nen: page.values.nen
                        , no_oi: page.values.no_oi
                        , tr_shisakuhin_bf: page.header.getChangeSetData()
                        , tr_haigo_bf: haigoChangeSet.tr_haigo
                        , tr_shisaku_bf: haigoChangeSet.tr_shisaku
                        , tr_shisaku_list_bf: haigoChangeSet.tr_shisaku_list
                        , tr_cyuui_bf: haigoChangeSet.tr_cyuui
                        , kanzanSeihoCopy: haigoChangeSet.kanzanSeiho
                        ...
                        , settingDefault: {
                            ...
                            , mark_12: App.settings.app.cd_mark.mark_12 // P
                            ...
                            , cd_tani_gr_g: App.settings.app.genryo_tani_AOH.Gram
                            , cd_tani_gr_kg: App.settings.app.genryo_tani_AOH.Kg
                            , cd_tani_gr_can: App.settings.app.genryo_tani_AOH.Can
                        }
                    };
                    ...
                    return $.ajax(App.ajax.webapi.post(page.commands.urls.save, changeSets)).then(function (result) {
                        ...
                        var href = App.str.format("151_ShishakuData.aspx?modeDisp={mode}&cd_shain={cd_shain}&nen={nen}&no_oi={no_oi}", {
                        ...
                        //メッセージIDをつくする。
                        var storeIDmess = App.str.format("151_ShishakuData_mess_{user}_{cd_shain}_{nen}_{no_oi}", {
                         ...
                         //左の位置IDをつくする。
                        storeIDpositionLeft = App.str.format("151_ShishakuData_positionLeft_{user}_{cd_shain}_{nen}_{no_oi}", {
                            user: App.ui.page.user.EmployeeCD
                            , cd_shain: result.cd_shain
                            , nen: result.nen
                            , no_oi: result.no_oi
                        ...
                        //アクティブタブIDをつくする。
                        storeIDactiveTab = App.str.format("151_ShishakuData_activeTab_{user}_{cd_shain}_{nen}_{no_oi}", {
                            user: App.ui.page.user.EmployeeCD
                            , cd_shain: result.cd_shain
                            , nen: result.nen
                            , no_oi: result.no_oi
                        ...
                        if (error.status === 400 && error.responseJSON == "ma_shisaku_saiban_bf") {
                            App.ui.page.notifyAlert.clear();
        ...
        */
        page.commands.shisakuSetsumeisho = function () {
            ...
            page.detail.tabs.haigohyo_tab.detail.shisakuPrintcheck().then(function (keySample) {
                ...
                return $.ajax(App.ajax.file.download(page.commands.urls.sanpuruSetsumeishoExcel156, filter)).then(function (response, status, xhr) {
                    //ExcelFile1 = response;
                    //xhr1 = xhr;
                    //status1 = status;
                    //filter.mode = page.values.paraExcel156;
        ...
        */
        page.commands.shisakuExport = function () {
            ...
            page.detail.tabs.haigohyo_tab.detail.shisakuPrintcheck().then(function (keySample) {
                ...
                return $.ajax(App.ajax.file.download(page.commands.urls.shishakuDataHyojiYokoExcel153, filter)).then(function (response, status, xhr) {

                    ExcelFile1 = response;
                    xhr1 = xhr;
                    status1 = status;

                    $.ajax(App.ajax.file.download(page.commands.urls.shishakuDataHaigoHyoExcel154, filter)).then(function (response, status, xhr) {
        ...
        page.commands.Tokuchokopi = function () {
            ...
            page.dialogs.confirmDialog.confirm({
                ...
                setTimeout(function () {
                    ...
                    dataCopi.pt_kotei = page.detail.element.findP("pt_kotei").val();//工程パターン  
                    ...
                    page.detail.element.findP("no_irai").val("");
        ...
        */
        page.initialize = function () {
            ...
            getKengenGamen(App.settings.app.id_gamen.shisaku_data_AOH).then(function (resultsKengen) {
                ...
                if (page.values.modeDisp == App.settings.app.m_shisaku_data.shosai
                    ...
                    if (hData) {
                        hData.pt_kotei = page.detail.element.findP("pt_kotei").val();
                    }
        ...
        */
        ...
        page.detail.recalcuFistStart = function () {
            ...
            var myTimer = function () {
                ...
                if (!page.detail.values.isCompleteTokuseichi) {
                    return;
                }
                ...
                setTimeout(function () {
                    ...
                    page.detail.recalculation("haigohyo_tab", "FirstStart");
                }, 1000)
        ...
        */
        page.controlInput = function () {
            ...
            setTimeout(function () {
                //左の位置IDを貰います
                var storeIDpositionLeft = App.str.format("151_ShishakuData_positionLeft_{user}_{cd_shain}_{nen}_{no_oi}", {
                    user: App.ui.page.user.EmployeeCD
                    , cd_shain: page.values.cd_shain
                    , nen: page.values.nen
                    , no_oi: page.values.no_oi
                ...
                if (positionLeftFromPage) {
                    ...
                    if (activeTabFromPage) {
                        if (activeTabFromPage === "HaigoHyo_Tab") {
                            page.detail.tabs.haigohyo_tab.setLastSavePosition();
                        } else {
        ...
        */
        ...
        page.detail.getKoteiPattern = function () {
            return page.detail.element.findP("pt_kotei").val();
        }
        ...
        */
        page.header.changeFromKihonTab = function (property, val, isRecalcu) {
            ...
            //工場　担当会社,工場　担当工場
            if (["", "cd_kojo", "cd_tani", "yoryo"].indexOf(property) > 0) {
        ...
        page.detail.getDataTab = function (tab) {
            switch (tab) {
                ...
                case "haigohyo_tab":
                    ...
                    break;
                case "haigohyo_tab_606":
                    return page.detail.tabs.haigohyo_tab.detail.allDataOnTabFor606();
                    break;
                case "tokuseichi_tab":
            ...
            page.detail.getDataTab("haigohyo_tab").then(function (dataHaigo) {
                ...
                switch (isTab) {
                    ...
                    //    })
                        ...
                        //    break;
                    case "haigohyo_tab":
                        if (isFiel === "FirstStart") {
                            page.detail.tabs.haigohyo_tab.detail.calculateTotal("FirstLoad");
                        }
                        if (isFiel === "ChangeKotei") {
                            page.detail.tabs.haigohyo_tab.detail.calculateTotal("ChangeKotei");
                        }
        ...
        */
        page.detail.addSample = function (data, isAddEndCol, isNewData, indexCol, isCopyCol) {
            ...
            if (isNewData) {
                ...
                HaigoHyo_Tab.detail.caculateTotalSample(data.seq_shisaku, (isCopyCol ? "試作列コピー" : "AddSample"));
            }
        };
        ...
        */
        page.commands.showGenzairyoKakuninDialog = function (e) {
            ...
            page.dialogs.GenzairyoKakuninDialog.ValidateListFieldsAllTabs_151(keySample).then(function () {
                ...
                page.detail.getDataTab("haigohyo_tab_606").then(function (dataHaigo) {
                    ...
                    // 平均充填量
                    var heikinzyu = (new BigNumber(data.r04 || 0)).times(new BigNumber(data.shisaku_hin.yoryo || 0));
                    if (!heikinzyu.eq(0)) {
                        heikinzyu = new BigNumber(1).div(heikinzyu);
                    }
                    if (data.shisaku_hin.cd_tani == App.settings.app.tani_AOH.kg || data.shisaku_hin.cd_tani == App.settings.app.tani_AOH.Lit) {
                        heikinzyu = heikinzyu.div(1000);
                    }
                    data["genka_shisan"] = {
                        // 平均充填量
                        heikinzyu: heikinzyu.toFixed(),
                        // 有効歩留
                        yukobudomari: 100,                        
                        // 水相比重
                        hiju_sui: 0
                    ...
                    // 内容量
                    data.shisaku_hin.yoryo = heikinzyu.toFixed();
                    // 入数
                    data.shisaku_hin.su_iri = 1;
                    $.each(data.shisaku, function (i, e) {
                        // 合計仕上重量
                        e.juryo_shiagari_g = 0;
                        // 試算依頼flg
                        e.flg_shisanIrai = 0;
                        // 工程属性
                        e.zoku_kotei = "004"
        ...
        page.loadMasterData = function () {
            ...
            var paraSearch = {
                ...
                kotei_patan_AOH: App.settings.app.cd_category.kotei_patan_AOH,
                Kotei_zokusei_AOH: App.settings.app.cd_category.Kotei_zokusei_AOH,
                ...
                genryo_tani_AOH: App.settings.app.cd_category.genryo_tani_AOH,
            }
        ...
        */
        ...
        page.loadDialogs = function () {
            ...
            return App.async.all({
                ...
                _650_SeizoKoteiDialog: $.get(page.dialogs.urls._650_SeizoKoteiDialog),
                ...
                $("#dialog-container").append(result.successes._650_SeizoKoteiDialog);
                //page.dialogs._650_SeizoKoteiDialog = _650_SeizoKoteiDialog;
                page.dialogs._650_SeizoKoteiDialog = _650_SeizoKoteiDialog;
                page.dialogs._650_SeizoKoteiDialog.initialize();
                page.dialogs._650_SeizoKoteiDialog.dataSelected = page.detail.SeizoKoteiKoshin;
        ...
        */
        ...
        /**
        * Get first column in formular
        * Fx format: ...{col-1-1}...
        */
        page.detail.getFirstColFromFormular = function (fx) {
            var beg = fx.indexOf("{"),
                end = fx.indexOf("}");
            if (beg < 0 || end < 0 || beg > end) {
                return null;
            }
            var arr = (fx.substring(beg + 1, end)).split("-");
            if (arr.length < 2) {
                return null;
            }
            return {
                colIndex: arr[1],
                koteiIndex: (arr.length > 2) ? arr[3] : null,
                isAllKotei: (arr.length == 2) ? true : false
            }
        }

        /**
        * Get first col choosen in dialog copy
        */
        page.detail.getFirstColFromDialog = function () {
            var element = page.dialogs.ShisakuRetuTuikaDialog.element;
            var firstCol = element.find("th:not(.th-tmpl) select[data-prop='seq_shisaku']:first");
            if (firstCol.length === 0) {
                return null;
            }
            var colIndex = firstCol.val();
            return {
                colIndex: colIndex
            }
        }
        ...
        */
        page.detail.removeComma = function (numStr) {
            if (App.isUndefOrNullOrStrEmpty(numStr)) return null;
            return numStr.replace(/,/g, "");
        }


        /**
        * Parse formular to elements
        */
        page.detail.parseFormular = function (fx) {
            if (!fx) return null;
            var BEG_CHAR = "{";
            var END_CHAR = "}";
            var ins = {
            ...
            var firstCol = page.detail.getFirstColFromFormular(fx);
            ins = $.extend(ins, firstCol);
            var nextCol = function () {
                var beg_inx = fx.indexOf(BEG_CHAR),
                    end_inx = fx.indexOf(END_CHAR);
                return {
                    beg_inx: beg_inx,
                    end_inx: end_inx,
                    name: fx.substring(beg_inx + 1, end_inx)
                }
            }
            // Parse fx into list of column name
            var col = nextCol();
            ins.eLst = [];
            while (col.beg_inx >= 0) {
                ins.eLst.push(col.name);
                fx = fx.substring(col.end_inx + 1);
                col = nextCol();
            }
            // Check if all param input obj are null for current fx
            ins.checkNullParam = function (pObj) {
                if (!pObj) {
                    return true;
                }
                var pLst = $.grep(Object.keys(pObj), function (item) {
                    return (ins.eLst.indexOf(item) >= 0);
                });
                var res = true;
                $.each(pLst, function (ind, item) {
                    if (!App.isUndefOrNullOrStrEmpty(pObj[item])) {
                        res = false;
                        return false;
                    }
                });
        ...
        */
        page.detail.addShisaku = function (data) {
            // For FC, Brix(%), pH, CA(%)
            var firstCol;
            if (!App.isUndefOrNullOrStrEmpty(data.siki_keisan)) {
                firstCol = page.detail.getFirstColFromDialog();
                if (firstCol != null) {
                    var element = HaigoHyo_Tab.detail.element.find(".sample-" + firstCol.colIndex);
                    var colData = element.form().data();
                    data.su_fc = page.detail.removeComma(colData.su_fc);
                    data.su_brix = page.detail.removeComma(colData.su_brix);
                    data.su_ph = page.detail.removeComma(colData.su_ph);
                    data.su_ca = page.detail.removeComma(colData.su_ca);
                }
            }
            page.detail.tabs.haigohyo_tab.detail.beforAddNewTrialManual(data).then(function (addNewColCopy) {
                ...
                //if (firstCol) {
                //    return HaigoHyo_Tab.detail.sikiList(page.detail.tabs.haigohyo_tab.detail.element.find(".sample-" + firstCol.colIndex), undefined, firstCol.colIndex);
                //}
            }).always(function () {
                App.ui.loading.close();
            })
        ...
        */
        page.detail.showSeizhoKouteiDialog = function (e) {
            ...
            page.dialogs._650_SeizoKoteiDialog.header.values.modeDisp = page.values.modeDisp;

            HaigoHyo_Tab.detail.trialManualCheked().then(function (results) {

                page.dialogs._650_SeizoKoteiDialog.header.values.isComplete = true;

                page.dialogs._650_SeizoKoteiDialog.header.values.seq_shisaku = results.seq_shisaku;
                page.dialogs._650_SeizoKoteiDialog.header.values.no_chui = (results.entity["no_chui"] != "" && results.entity["no_chui"]) ? results.entity["no_chui"] : null;
                page.dialogs._650_SeizoKoteiDialog.header.values.entity = results.entity;
                page.dialogs._650_SeizoKoteiDialog.header.values.shisakuHin = page.header.getData();
                page.dialogs._650_SeizoKoteiDialog.header.values.dataChui = results.dataChui;
                page.dialogs._650_SeizoKoteiDialog.element.modal("show");
            })
        };
        ...
        */
        page.detail.SeizoKoteiKoshin = function (data) {
            ...
            //オリジナル常に表示が変更しました。
            if (_650_SeizoKoteiDialog.values.flg_chui_org != undefined) {
            ...
            HaigoHyo_Tab.detail.trialManualCheked().then(function (results) {
                ...
                page.dialogs.confirmDialog.confirm({
                    ...
                    if (data["mode"] == "addNew") {
                        _650_SeizoKoteiDialog.header.values.no_chui = page.values.masterData.no_chui_max;
                        page.dialogs._650_SeizoKoteiDialog.afterKoshin();
                    }
                    setTimeout(function () {
                        page.dialogs._650_SeizoKoteiDialog.header.values.isComplete = true;
                    }, 100)
        ...
        page.loadData = function () {
            if (page.values.modeDisp == App.settings.app.m_shisaku_data.shinki) {
                page.header.bind({
                    ...
                    pt_kotei: App.settings.app.kotei_pattern_AOH.Fixed,//工程パターン
                    ...
                    cd_hanseki: App.settings.app.kaisha_AOH
                }, true);
                debugger
                return App.async.success();
            }
        ...
        * 試作品テーブルデータを取りする。
        */
        page.header.getDataOrg = function () {
            var element = page.header.element,
               id = element.attr("data-key"),
               entity = page.header.data.entry(id);
        ...
        */
        page.detail.changeKoteiPatan = function (e) {
            ...
            var updateAcces = function () {
                ...
                //・原価試算タブ．原料費の再計算を行う
                //page.detail.recalculation("tokuseichi_tab", "工程パターン");
                page.detail.recalculation("haigohyo_tab", "ChangeKotei");
                //}
                ...
                <div class="row">
                    <div class="col-xs-6" style="padding: 0px;">
                        <div class="row">
                            ...
                            <div class="control col-xs-2">
                                <input type="text" data-prop="no_irai" class="tokucho-copy-input-blank text-selectAll">
                            </div>
                    ...
                    <div class="col-xs-6" style="padding: 0px;">
                        ...
                        <div class="row">
                            ...
                            <div class="control col-xs-5 fix-label-xmd">
                                <%--<div class="lb">
...
<asp:Content ID="FooterContent" ContentPlaceHolderID="FooterContent" runat="server">
    <div class="command-left" id="command_left">
        ...
        <button type="button" id="ShisakuSetsumeisho" class="btn btn-sm btn-primary command-haigohyo-tab command-button">サンプル説明書</button>
    </div>
