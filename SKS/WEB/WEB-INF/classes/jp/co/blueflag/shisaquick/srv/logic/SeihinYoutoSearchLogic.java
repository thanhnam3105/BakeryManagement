 ...
 * @since  2009/03/29
 */
public class SeihinYoutoSearchLogic extends LogicBase{
	
	/**
	 * コンボ用：製品の用途情報検索DB処理用コンストラクタ 
	 * : インスタンス生成
	 */
	public SeihinYoutoSearchLogic() {
		//基底クラスのコンストラクタ
		super();
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning {
		...
		try {
			...
			//レスポンスデータの形成
			storageSeihinYoutoCmb(lstRecset, resKind.getTableItem(0));
	...
	/**
	 * コンボ用：製品の用途パラメーター格納
	 *  : 製品の用途コンボボックス情報をレスポンスデータへ格納する。
	 * @param lstSeihinYoutoCmb : 検索結果情報リスト
	 * @throws ExceptionWaning 
	 * @throws ExceptionUser 
	 * @throws ExceptionSystem 
	 */
	private void storageSeihinYoutoCmb(List<?> lstSeihinYoutoCmb, RequestResponsTableBean resTable) 
		throws ExceptionSystem, ExceptionUser, ExceptionWaning{

		try {
			
			for (int i = 0; i < lstSeihinYoutoCmb.size(); i++) {
				...
				Object[] items = (Object[]) lstSeihinYoutoCmb.get(i);
