...
/**
 * 
 * 【S3-73 : SA780】 JWSリテラル検索（賞味期間）ＤＢ処理の実装
 ...
 *
 */
public class JWSLiteralShomiSearchLogic extends LogicBase {
	 ...
	 * コンストラクタ
	 */
	public JWSLiteralShomiSearchLogic() {
		//基底クラスのコンストラクタ
		super();
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning {
		...
		try {
			//カテゴリコードの設定
			String strCd_Categori = "K_syomikikan";
			//検索処理を行い、結果を格納する。
