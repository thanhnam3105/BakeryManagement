 ...
 * @since  2011/01/28
 */
public class FGEN2070_Logic extends LogicBase{
	
	/**
	 * 担当者マスタメンテ（営業）　部署検索（営業部所のみ）
	 * : インスタンス生成
	 */
	public FGEN2070_Logic() {
		//基底クラスのコンストラクタ
		super();
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning {
		...
		try {
			...
			this.em.ThrowException(e, "担当者マスタメンテ（営業）　部署検索（営業部所のみ）処理が失敗しました。");
...
// 【QP@10713】2011/10/28 TT H.SHIMA -ADD Start
			int eigyo_kengen = Integer.parseInt(reqData.getFieldVale(0, 0, "eigyo_kengen"));
// 【QP@10713】2011/10/28 TT H.SHIMA -ADD End
			...
			strSql.append(" WHERE   ");
			strSql.append(" 	cd_kaisha = "+cd_kaisha);
			strSql.append(" 	AND flg_eigyo = 1   ");
// 【QP@10713】2011/10/28 TT H.SHIMA -ADD Start
			if(eigyo_kengen == 2){
				strSql.append(" 	AND flg_honbu = 1   ");
			}
// 【QP@10713】2011/10/28 TT H.SHIMA -ADD End
