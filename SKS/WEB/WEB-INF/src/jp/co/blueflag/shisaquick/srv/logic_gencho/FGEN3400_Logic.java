 ...
 * @since  2014/09/04
 */
public class FGEN3400_Logic extends LogicBase{

	/**
	 * カテゴリ検索
	 * : インスタンス生成
	 */
	public FGEN3400_Logic() {
		//基底クラスのコンストラクタ
		super();
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning {
		...
		try {
			...
			// 検索結果がない場合
			if (lstRecset.size() == 0){
				em.ThrowException(ExceptionKind.警告Exception,"W000501", "参考資料（リテラルマスタ）", "", "");
			}
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning{
		...
		try {
			...
			strSql.append(" WHERE cd_category = 'C_sankosiryo'  ");
