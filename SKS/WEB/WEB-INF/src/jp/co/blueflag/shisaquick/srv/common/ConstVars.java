...
//	public static final String APPCONTEXT_NM_DAO = "conf/appContext_BD.xml";
	...
	//サーブレットXMLリクエストエンコード（変更不可）
	public static final String SRV_XML_REQ_ENCODE = "UTF-8";

	//サーブレットXMLレスポンスエンコード（変更不可）
	public static final String SRV_XML_RESP_ENCODE = "text/xml; charset=UTF-8";
	
	//サーブレットURL変数リクエストエンコード
	public static final String SRV_URL_REQ_ENCODE = "MS932";

	//サーブレットHTMLキャラセット（SRV_URL_REQ_ENCODEと対に成っている必要がある）
	public static final String SRV_HTML_CHARSET = "text/html; charset=Windows-31J";
