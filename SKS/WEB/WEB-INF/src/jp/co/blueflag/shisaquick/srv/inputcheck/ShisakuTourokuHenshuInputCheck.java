...
/**
 *
 * 【JW040】 試作データ画面リクエスト登録（編集） インプットチェック
 *
 */
public class ShisakuTourokuHenshuInputCheck extends InputCheck {

	/**
	 * コンストラクタ
	 *  : 試作データ画面 初期表示時インプットチェック用コンストラクタ
	 */
	public ShisakuTourokuHenshuInputCheck() {
		//基底クラスのコンストラクタ
		super();
...
// ADD end 20121003 QP@20505 No.24
	 ...
	 * @param checkData : リクエストデータ
	 * @return 配合テーブル.工程順 + ":::" + 配合テーブル.原料コード
	 *             文字列「:::」で区切る
	 * @throws ExceptionSystem
	 * @throws ExceptionUser
	 * @throws ExceptionWaning
