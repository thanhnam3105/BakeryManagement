 ...
 * 
 *  営業担当検索サブ画面 テーブルクラス
 *  :  営業担当検索サブ画面テーブルコントロールを設定する
 * 
 * @author TT.Nishigawa
 * @since 2011/02/10
 *
 */
public class EigyoTantoSearchTable {
	 ...
	 */
	public EigyoTantoSearchTable( int intRow, int intCol, Object[] columnNm, int[] columnWidth ) throws ExceptionBase{
