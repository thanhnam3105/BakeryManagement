...
public class ShisakuTblSearchLogic extends LogicBase {
	...
	private StringBuffer shisakuhinDataCreateSQL() throws Exception {
		...
		strRetSQL.append(" ,ISNULL(T110.cd_eigyo,'') AS cd_eigyo  ");
	...
	private StringBuffer haigoDataCreateSQL() throws Exception {
		...
		strRetSQL.append(" ,ISNULL(CONVERT(VARCHAR,T120.nm_genryo),'') AS nm_genryo ");

		//単価
		strRetSQL.append(" ,CASE IsNull(CAST(T120.tanka AS varchar),'') WHEN ''");
		strRetSQL.append(" 	THEN CAST('' AS varchar)");
		strRetSQL.append(" 	ELSE LTRIM(STR(T120.tanka,8,2))");
...
//			this.searchDB.Close();
	 ...
	 * @since  2009/03/30
	 */
	private StringBuffer genkaGenryoDataCreateSQL() throws ExceptionSystem, ExceptionUser, ExceptionWaning {
		StringBuffer strRetSQL = null;
		...
		try {
			...
			//検索用SQLの記述
			strRetSQL.append(" SELECT ");
			strRetSQL.append(" T141.cd_shain ");
			strRetSQL.append(" ,T141.nen ");
			strRetSQL.append(" ,T141.no_oi ");
			strRetSQL.append(" ,ISNULL(T141.seq_shizai,0) ");
			strRetSQL.append(" ,ISNULL(T141.flg_print,'') ");
			strRetSQL.append(" ,ISNULL(T141.zyusui,'') ");
			strRetSQL.append(" ,ISNULL(T141.zyuabura,'') ");
			strRetSQL.append(" ,ISNULL(T141.gokei,'') ");
			strRetSQL.append(" ,ISNULL(T141.genryohi,'') ");
			strRetSQL.append(" ,ISNULL(T141.genryohi1,'') ");
			strRetSQL.append(" ,ISNULL(T141.hiju,'') ");
			strRetSQL.append(" ,ISNULL(T141.yoryo,'') ");
			strRetSQL.append(" ,ISNULL(T141.irisu,'') ");
			strRetSQL.append(" ,ISNULL(T141.yukobudomari,'') ");
			strRetSQL.append(" ,ISNULL(T141.reberu,'') ");
			strRetSQL.append(" ,ISNULL(T141.hizyubudomari,'') ");
			strRetSQL.append(" ,ISNULL(T141.heikinzyu,'') ");
			strRetSQL.append(" ,ISNULL(T141.cs_genryo,'') ");
			strRetSQL.append(" ,ISNULL(T141.cs_zairyohi,'') ");
			strRetSQL.append(" ,ISNULL(T141.cs_keihi,'') ");
			strRetSQL.append(" ,ISNULL(T141.cs_genka,'') ");
			strRetSQL.append(" ,ISNULL(T141.ko_genka,'') ");
			strRetSQL.append(" ,ISNULL(T141.ko_baika,'') ");
			strRetSQL.append(" ,ISNULL(T141.ko_riritu,'') ");
			strRetSQL.append(" ,ISNULL(T141.id_toroku,0) ");
			strRetSQL.append(" ,ISNULL(T141.dt_toroku,'') ");
			strRetSQL.append(" ,ISNULL(T141.id_koshin,0) ");
			strRetSQL.append(" ,ISNULL(T141.dt_koshin,'') ");
			// 登録者名, 更新者名
			strRetSQL.append(" ,ISNULL(M101_t.nm_user,'') AS nm_toroku, ISNULL(M101_u.nm_user,'') AS nm_koshin ");
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning {
		...
		try {
			...
			for (int i = 0; i < lstTantouShaData.size(); i++) {
				...
				resTable.addFieldVale("rec" + i, "cd_eigyo", items[17].toString());
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning {
		...
		try {
			...
			for (int i = 0; i < lstTantouShaData.size(); i++) {
				...
				resTable.addFieldVale("rec" + i, "flg_print", items[9].toString());
				resTable.addFieldVale("rec" + i, "flg_auto", items[10].toString());
				resTable.addFieldVale("rec" + i, "no_shisan", items[11].toString());
				resTable.addFieldVale("rec" + i, "no_seiho1", items[12].toString());
				resTable.addFieldVale("rec" + i, "no_seiho2", items[13].toString());
				resTable.addFieldVale("rec" + i, "no_seiho3", items[14].toString());
				resTable.addFieldVale("rec" + i, "no_seiho4", items[15].toString());
				resTable.addFieldVale("rec" + i, "no_seiho5", items[16].toString());
				resTable.addFieldVale("rec" + i, "ritu_sousan", items[17].toString());
				resTable.addFieldVale("rec" + i, "flg_sousan", items[18].toString());
				resTable.addFieldVale("rec" + i, "ritu_shokuen", items[19].toString());
				resTable.addFieldVale("rec" + i, "flg_shokuen", items[20].toString());
				resTable.addFieldVale("rec" + i, "sando_suiso", items[21].toString());
				resTable.addFieldVale("rec" + i, "flg_sando_suiso", items[22].toString());
				resTable.addFieldVale("rec" + i, "shokuen_suiso", items[23].toString());
				resTable.addFieldVale("rec" + i, "flg_shokuen_suiso", items[24].toString());
				resTable.addFieldVale("rec" + i, "sakusan_suiso", items[25].toString());
				resTable.addFieldVale("rec" + i, "flg_sakusan_suiso", items[26].toString());
				resTable.addFieldVale("rec" + i, "toudo", items[27].toString());
				resTable.addFieldVale("rec" + i, "flg_toudo", items[28].toString());
				resTable.addFieldVale("rec" + i, "nendo", items[29].toString());
				resTable.addFieldVale("rec" + i, "flg_nendo", items[30].toString());
				resTable.addFieldVale("rec" + i, "ondo", items[31].toString());
				resTable.addFieldVale("rec" + i, "flg_ondo", items[32].toString());
				resTable.addFieldVale("rec" + i, "ph", items[33].toString());
				resTable.addFieldVale("rec" + i, "flg_ph", items[34].toString());
				resTable.addFieldVale("rec" + i, "ritu_sousan_bunseki", items[35].toString());
				resTable.addFieldVale("rec" + i, "flg_sousan_bunseki", items[36].toString());
				resTable.addFieldVale("rec" + i, "ritu_shokuen_bunseki", items[37].toString());
				resTable.addFieldVale("rec" + i, "flg_shokuen_bunseki", items[38].toString());
				resTable.addFieldVale("rec" + i, "hiju", items[39].toString());
				resTable.addFieldVale("rec" + i, "flg_hiju", items[40].toString());
				resTable.addFieldVale("rec" + i, "suibun_kasei", items[41].toString());
				resTable.addFieldVale("rec" + i, "flg_suibun_kasei", items[42].toString());
				resTable.addFieldVale("rec" + i, "alcohol", items[43].toString());
				resTable.addFieldVale("rec" + i, "flg_alcohol", items[44].toString());
				resTable.addFieldVale("rec" + i, "memo_sakusei", items[45].toString());
				resTable.addFieldVale("rec" + i, "flg_memo", items[46].toString());
				resTable.addFieldVale("rec" + i, "hyoka", items[47].toString());
				resTable.addFieldVale("rec" + i, "flg_hyoka", items[48].toString());
				resTable.addFieldVale("rec" + i, "free_title1", items[49].toString());
				resTable.addFieldVale("rec" + i, "free_value1", items[50].toString());
				resTable.addFieldVale("rec" + i, "flg_free1", items[51].toString());
				resTable.addFieldVale("rec" + i, "free_title2", items[52].toString());
				resTable.addFieldVale("rec" + i, "free_value2", items[53].toString());
				resTable.addFieldVale("rec" + i, "flg_free2", items[54].toString());
				resTable.addFieldVale("rec" + i, "free_title3", items[55].toString());
				resTable.addFieldVale("rec" + i, "free_value3", items[56].toString());
				resTable.addFieldVale("rec" + i, "flg_free3", items[57].toString());
				resTable.addFieldVale("rec" + i, "dt_shisaku", items[58].toString());
				resTable.addFieldVale("rec" + i, "juryo_shiagari_g", items[59].toString());
				resTable.addFieldVale("rec" + i, "id_toroku", items[60].toString());
				resTable.addFieldVale("rec" + i, "dt_toroku", items[61].toString());
				resTable.addFieldVale("rec" + i, "id_koshin", items[62].toString());
				resTable.addFieldVale("rec" + i, "dt_koshin", items[63].toString());
				resTable.addFieldVale("rec" + i, "nm_koshin", items[64].toString());
				resTable.addFieldVale("rec" + i, "nm_toroku", items[65].toString());
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning {
		...
		try {
			...
			for (int i = 0; i < lstTantouShaData.size(); i++) {
				...
				resTable.addFieldVale("rec" + i, "no_oi", items[2].toString());
				resTable.addFieldVale("rec" + i, "seq_shisaku", items[3].toString());
				resTable.addFieldVale("rec" + i, "no_chui", items[4].toString());
				resTable.addFieldVale("rec" + i, "chuijiko", items[5].toString());
				resTable.addFieldVale("rec" + i, "id_toroku", items[6].toString());
				resTable.addFieldVale("rec" + i, "dt_toroku", items[7].toString());
				resTable.addFieldVale("rec" + i, "id_koshin", items[8].toString());
				resTable.addFieldVale("rec" + i, "dt_koshin", items[9].toString());
				resTable.addFieldVale("rec" + i, "nm_koshin", items[10].toString());
				resTable.addFieldVale("rec" + i, "nm_toroku", items[11].toString());
