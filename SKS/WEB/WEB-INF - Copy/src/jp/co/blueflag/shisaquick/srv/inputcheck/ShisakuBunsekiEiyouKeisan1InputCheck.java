...
public class ShisakuBunsekiEiyouKeisan1InputCheck extends InputCheck {
	...
	private void outputKeyCheckEiyou1(RequestData checkData) throws ExceptionSystem,
		...
		try {
		    ...
		    super.hissuInputCheck(checkData.GetValueStr("SA430", 0, 0, "cd_shain"),"試作CD-社員CD");
		    super.hissuInputCheck(checkData.GetValueStr("SA430", 0, 0, "nen"),"試作CD-年");
		    super.hissuInputCheck(checkData.GetValueStr("SA430", 0, 0, "no_oi"),"試作CD-追番");
		    String strShisakuSeq = checkData.GetValueStr("SA430", 0, 0, "seq_shisaku"); 
		    if (strShisakuSeq.equals("0")) {
		    	strShisakuSeq = "";
		    }
		    super.hissuCodeCheck(strShisakuSeq,"試作列");
	...
	private void outputKeyCheckEiyou2(RequestData checkData) throws ExceptionSystem,
		...
		try {
			...
			// ①：必須項目の入力チェック（スーパークラスの必須チェック）を行う。
		    super.hissuInputCheck(checkData.GetValueStr("SA440", 0, 0, "cd_shain"),"試作CD-社員CD");
		    super.hissuInputCheck(checkData.GetValueStr("SA440", 0, 0, "nen"),"試作CD-年");
		    super.hissuInputCheck(checkData.GetValueStr("SA440", 0, 0, "no_oi"),"試作CD-追番");
		    String strShisakuSeq = checkData.GetValueStr("SA440", 0, 0, "seq_shisaku"); 
		    if (strShisakuSeq.equals("0")) {
		    	strShisakuSeq = "";
		    }
		    super.hissuCodeCheck(strShisakuSeq,"試作列");
