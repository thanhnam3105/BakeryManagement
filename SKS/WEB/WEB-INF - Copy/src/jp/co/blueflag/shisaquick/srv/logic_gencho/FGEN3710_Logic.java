 ...
 * @since  2016/10/27
 */
public class FGEN3710_Logic extends LogicBase{

	/**
	 * コストテーブル取得処理
	 * : インスタンス生成
	 */
	public FGEN3710_Logic() {
		//基底クラスのコンストラクタ
		super();
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning{
		...
		try {
			...
			String strChkMishiyo = reqData.getFieldVale(0, 0, "chk_mishiyo");
            ...
            if(strChkMishiyo.equals("1")){
            	...
            	strWork.append(" ISNULL(M1.flg_mishiyo,'0') = " + strChkMishiyo);
            } else{
				if(strWork.length() > 0){
					strWork.append(" AND ");
				}
