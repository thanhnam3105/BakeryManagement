 ...
 * @since  2014/08/21
 */
public class FGEN3100_Logic extends LogicBase{

	/**
	 * コストテーブル取得処理
	 * : インスタンス生成
	 */
	public FGEN3100_Logic() {
		//基底クラスのコンストラクタ
		super();
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning{
		...
		try {
			...
			strSql.append("    LST.name_hansu AS nm_houzai ");
			strSql.append("FROM ");
			...
			strSql.append("    LEFT JOIN ma_user M3 ON M3.id_user = LST.id_kakunin");	//	【KPX@1602367】 mod
...
//				resTable.addFieldVale(i, "nm_houzai", toString(items[4],""));		// 包材名
				resTable.addFieldVale(i, "nm_houzai", toString(items[9],""));	// 版の包材名（旧:包材名）
