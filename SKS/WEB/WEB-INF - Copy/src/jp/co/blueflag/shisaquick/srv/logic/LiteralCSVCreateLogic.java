...
public class LiteralCSVCreateLogic extends LogicBaseCSV {
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning {
		...
		try {
			...
			//CSVファイル生成
			strFilePath = CSVOutput("カテゴリマスタ", lstRecset);
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning{
		...
		try {
			...
			em.ThrowException(e, "カテゴリデータ、DB検索に失敗しました。");
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning{
		...
		try {
			...
			this.em.ThrowException(e, "カテゴリデータCSV、検索SQLの生成に失敗しました。");
