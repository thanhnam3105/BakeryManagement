 ...
 * @since  2009/03/29
 */
public class UserSearchLogic extends LogicBase{
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning {
		...
		try {
			...
			//レスポンスデータの形成
			storageUserCmb(lstRecset, resKind.getTableItem(0));
	...
	/**
	 * コンボ用：ユーザーパラメーター格納
	 *  : ユーザーコンボボックス情報をレスポンスデータへ格納する。
	 * @param lstUserCmb : 検索結果情報リスト
	 * @throws ExceptionWaning 
	 * @throws ExceptionUser 
	 * @throws ExceptionSystem 
	 */
	private void storageUserCmb(List<?> lstUserCmb, RequestResponsTableBean resTable) 
		throws ExceptionSystem, ExceptionUser, ExceptionWaning{

		try {
			
			for (int i = 0; i < lstUserCmb.size(); i++) {
				...
				Object[] items = (Object[]) lstUserCmb.get(i);
