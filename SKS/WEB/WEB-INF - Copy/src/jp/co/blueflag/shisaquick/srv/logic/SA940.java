 ...
 * 【SA930】 JWSリテラル検索（調味料２液タイプ　工程属性）ＤＢ処理の実装
 * 
 * @author TT.Nishigawa
 * @since 2011/05/30
 *
 */
public class SA940 extends LogicBase {
	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning {
		...
		try {
			...
			if(lstRecset.size() == 0){
				//リテラルマスタの設定が正しくない
				em.ThrowException(ExceptionKind.一般Exception, "E000409", "", "", "");
			}
