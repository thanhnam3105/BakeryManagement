	...
	throws ExceptionSystem, ExceptionUser, ExceptionWaning {
		...
		try {
			...
			//権限データが「所属会社のみ」の場合
				...
				// MOD 2014/06/04 QP@30154 hisahori start
				//if(strKinoId.equals("21") == false){
				if(strKinoId.equals("21") == false && strKinoId.equals("20") == false && strKinoId.equals("24") == false){
				// MOD 2014/06/04 QP@30154 hisahori end
