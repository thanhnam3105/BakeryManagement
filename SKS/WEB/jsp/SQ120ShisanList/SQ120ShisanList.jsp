...
<html>
    ...
    <!--//
		window.onunload = function() {
			...
			<!-- 【QP@20505】2012/09/14 TT H.Shima ADD Start -->
			document.getElementById("xmlJSP0320").src = null;
			<!-- 【QP@20505】2012/09/14 TT H.Shima ADD End -->
			...
			<!-- ADD【H24年度対応】20120404 hagiwara E -->

			<!-- 【QP@20505】2012/09/20 TT H.Shima ADD Start -->
			document.getElementById("xmlRGEN2220").src = null;
			<!-- 【QP@20505】2012/09/20 TT H.Shima ADD End   -->
    ...
    <body class="pfcancel" onLoad="funLoad();">
		...
		<div id="container">
			<ul id="tab">
				...
				<li><a href="#page2" id="itiran" tabindex="2">全アイテム一覧</a></li>
			</ul>
		</div>
        ...
        <form name="frm00" id="frm00" method="post">
            ...
            <table width="99%">
                <tr>
                    ...
                    <td width="55%" align="right">
                    	...
                    	<!-- MOD【H24年度対応】20120402 hagiwara S -->
                        <!--
                        ...
                        <input type="button" class="normalbutton" id="btnSearch" name="btnSearch" value="検索" tabindex="17">
                        <input type="button" class="normalbutton" id="btnClear" name="btnClear" value="クリア" onClick="funClear();" tabindex="18">
                        <input type="button" class="normalbutton" id="btnPrint" name="btnPrint" value="一覧出力" onClick="funOutput();" tabindex="19">
                        <input type="button" class="normalbutton" id="btnEnd" name="btnEnd" value="終了" onClick="funNext(0);" tabindex="20">
                         -->
                        <!-- MOD【H24年度対応】20120402 hagiwara E -->
                        <input type="button" class="normalbutton" id="btnSearch" name="btnSearch" value="検索" tabindex="18">
                        <input type="button" class="normalbutton" id="btnClear" name="btnClear" value="クリア" onClick="funClear();" tabindex="19">
                        <input type="button" class="normalbutton" id="btnPrint" name="btnPrint" value="一覧出力" onClick="funOutput();" tabindex="20">
                        <input type="button" class="normalbutton" id="btnEnd" name="btnEnd" value="終了" onClick="funNext(0);" tabindex="21">
            ...
            <table width="960">
                ...
                <tr>
                    ...
                    <td width="200">
<!-- 2013/07/3 ogawa 【QP@30151】No.39 start -->
<!-- 修正前ソース -->
<!--
...
<!-- 2013/07/3 ogawa 【QP@30151】No.39 end -->
                        </span>
                    </td>
            ...
            <table width="960">
                ...
                <tr>
                    ...
                    <td width="200">
                     ...
                     -->
                    <!-- 【QP@40812】No.24 MOD start 2015/03/03 TT.Kitazawa -->
                    <!-- <td width="100">担当者</td> -->
                    <td width="100">研担当者</td>
                    <!-- 【QP@40812】No.24 MOD end 2015/03/03 TT.Kitazawa -->
                    <td width="200">
            ...
            <table width="960">
                ...
                <tr>
                    ...
                    <td width="180" align="right">
                    	...
                    	<!--
                    	<!-- MOD【H24年度対応】20120402 hagiwara S -->
                        <!-- <input type="button" class="normalbutton" value="検索条件クリア" style="width:150px;" onClick="funClear_zyoken();" tabindex="21"> -->
                        <!-- MOD【H24年度対応】20120402 hagiwara E -->
                        <input type="button" class="normalbutton" value="検索条件クリア" style="width:150px;" onClick="funClear_zyoken();" tabindex="22">
                    	<!-- 【QP@20505】No.31 2012/09/14 TT H.Shima MOD End -->
                    </td>
                    <td width="58">&nbsp;</td>
                </tr>
...
<!--                         	<input type="button" style="visibility:hidden" class="normalbutton" id="btnGenka" name="btnGenka" value="原価試算" onClick="funNextPage(1);" tabindex="23"> -->
<!--                         	<input type="button" style="visibility:hidden" class="normalbutton" id="btnGenka_Eigyo" name="btnGenka_Eigyo" value="原価試算（営業）" onClick="funNextPage(2);" tabindex="24"> -->
                        <input type="button" style="visibility:hidden" class="normalbutton" id="btnGenka" name="btnGenka" value="原価試算" onClick="funGenkaOpen(1);" tabindex="23">
                        <input type="button" style="visibility:hidden" class="normalbutton" id="btnGenka_Eigyo" name="btnGenka_Eigyo" value="原価試算（営業）" onClick="funGenkaOpen(2);" tabindex="24">
                        <!-- MOD 2013/10/22 QP@30154 okano end -->
                        <input type="button" class="normalbutton" id="btnStatusRireki" name="btnStatusRireki" value="ステータス履歴" onClick="funNextPage(3);" tabindex="25">
                        <!-- 【QP@20505】No.31 2012/09/14 TT H.Shima ADD End   -->
                    </td>
                </tr>
            </table>
