...
//========================================================================================
function funFileDownloadUrlConnect(ConnectPattern, FormObject) {

    var pos_top;
    var pos_left;
    var height;
    var param;
    var wUrl = "/" + ConUrlPath + "/FileDownLoadServlet";
  ...
  //【QP@40404】mod start TT E.Kitazawa 2014/12/03
...
//            ",status=yes,toolbar=no,menubar=no";
    ...
    //【QP@40404】mod end TT E.Kitazawa 2014/12/03
