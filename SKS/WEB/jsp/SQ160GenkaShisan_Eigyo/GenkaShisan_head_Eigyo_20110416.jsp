            ...
            <table width="99%">
                <tr>
                    ...
                    <td width="45%" align="right">
                        ...
                        <input type="button" class="normalbutton" id="btnEnd" name="btnEnd" value="終了" onClick="funEnd()" tabindex="2">
                    </td>
                </tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" datasrc="" datafld="" border="0">
                ...
                <tr>
                    ...
                    <td rowspan="3" align="right">
                    	<input type="button" class="normalbutton" id="btnStatusRireki" name="btnStatusRireki" value="ｽﾃｰﾀｽ履歴" onClick="funStatusRireki_btn();" tabindex="3"><br/>
                    	<input type="button" class="normalbutton" id="btnHaita" name="btnHaita" value="使用中表示" onClick="funHaitaDisp_btn();" tabindex="4"><br/>
                    	<input type="button" class="normalbutton" id="btnHelp" name="btnHelp" value="ヘルプ表示" onClick="funHelpDisp();" tabindex="5">
                    </td>
                </tr>
